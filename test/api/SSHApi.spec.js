...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.SSHApi();
  });
  ...
  describe('SSHApi', function() {
    describe('addKeyToServer', function() {
      it('should call addKeyToServer successfully', function(done) {
        //uncomment below and update the code to test addKeyToServer
        //instance.addKeyToServer(function(error) {
    ...
    describe('deleteKeyFromServer', function() {
      it('should call deleteKeyFromServer successfully', function(done) {
        //uncomment below and update the code to test deleteKeyFromServer
        //instance.deleteKeyFromServer(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
