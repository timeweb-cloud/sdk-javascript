...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.ContainerRegistryApi();
  });
  ...
  describe('ContainerRegistryApi', function() {
    ...
    describe('getRegistryPresets', function() {
      it('should call getRegistryPresets successfully', function(done) {
        //uncomment below and update the code to test getRegistryPresets
        //instance.getRegistryPresets(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getRegistryRepositories', function() {
      it('should call getRegistryRepositories successfully', function(done) {
        //uncomment below and update the code to test getRegistryRepositories
        //instance.getRegistryRepositories(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
