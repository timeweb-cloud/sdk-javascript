...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.S3Api();
  });
  ...
  describe('S3Api', function() {
    describe('addStorageSubdomainCertificate', function() {
      it('should call addStorageSubdomainCertificate successfully', function(done) {
        //uncomment below and update the code to test addStorageSubdomainCertificate
        //instance.addStorageSubdomainCertificate(function(error) {
    ...
    describe('addStorageSubdomains', function() {
      it('should call addStorageSubdomains successfully', function(done) {
        //uncomment below and update the code to test addStorageSubdomains
        //instance.addStorageSubdomains(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getStorageSubdomains', function() {
      it('should call getStorageSubdomains successfully', function(done) {
        ...
        //instance.getStorageSubdomains(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getStorageTransferStatus', function() {
      it('should call getStorageTransferStatus successfully', function(done) {
        //uncomment below and update the code to test getStorageTransferStatus
        //instance.getStorageTransferStatus(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getStorageUsers', function() {
      it('should call getStorageUsers successfully', function(done) {
        //uncomment below and update the code to test getStorageUsers
        //instance.getStorageUsers(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getStoragesPresets', function() {
      it('should call getStoragesPresets successfully', function(done) {
        //uncomment below and update the code to test getStoragesPresets
        //instance.getStoragesPresets(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('transferStorage', function() {
      it('should call transferStorage successfully', function(done) {
        ...
        //instance.transferStorage(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateStorageUser', function() {
