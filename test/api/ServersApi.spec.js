...
(function(root, factory) {
  ...
  describe('ServersApi', function() {
    ...
    describe('getServerStatisticsNew', function() {
      it('should call getServerStatisticsNew successfully', function(done) {
        //uncomment below and update the code to test getServerStatisticsNew
        //instance.getServerStatisticsNew(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
