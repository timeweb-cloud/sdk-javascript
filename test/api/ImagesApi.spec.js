...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.ImagesApi();
  });
  ...
  describe('ImagesApi', function() {
    ...
    describe('createImageDownloadUrl', function() {
      it('should call createImageDownloadUrl successfully', function(done) {
        //uncomment below and update the code to test createImageDownloadUrl
        //instance.createImageDownloadUrl(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('deleteImageDownloadURL', function() {
      it('should call deleteImageDownloadURL successfully', function(done) {
        //uncomment below and update the code to test deleteImageDownloadURL
        //instance.deleteImageDownloadURL(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getImageDownloadURL', function() {
      it('should call getImageDownloadURL successfully', function(done) {
        //uncomment below and update the code to test getImageDownloadURL
        //instance.getImageDownloadURL(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getImageDownloadURLs', function() {
      it('should call getImageDownloadURLs successfully', function(done) {
        //uncomment below and update the code to test getImageDownloadURLs
        //instance.getImageDownloadURLs(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
