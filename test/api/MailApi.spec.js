...
(function(root, factory) {
  ...
  describe('MailApi', function() {
    ...
    describe('getMailQuota', function() {
      it('should call getMailQuota successfully', function(done) {
        //uncomment below and update the code to test getMailQuota
        //instance.getMailQuota(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateMailQuota', function() {
      it('should call updateMailQuota successfully', function(done) {
        //uncomment below and update the code to test updateMailQuota
        //instance.updateMailQuota(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
