...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.APIKeysApi();
  });
  ...
  describe('APIKeysApi', function() {
    ...
    describe('reissueToken', function() {
      it('should call reissueToken successfully', function(done) {
        //uncomment below and update the code to test reissueToken
        //instance.reissueToken(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
