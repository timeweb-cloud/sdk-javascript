...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.NodeGroupIn();
  });
  ...
  describe('NodeGroupIn', function() {
    it('should create an instance of NodeGroupIn', function() {
      // uncomment below and update the code to test NodeGroupIn
      //var instance = new TimewebCloudApi.NodeGroupIn();
      //expect(instance).to.be.a(TimewebCloudApi.NodeGroupIn);
    });
    ...
    it('should have the property isAutoscaling (base name: "is_autoscaling")', function() {
      // uncomment below and update the code to test the property isAutoscaling
      //var instance = new TimewebCloudApi.NodeGroupIn();
      //expect(instance).to.be();
    });

    it('should have the property minSize (base name: "min-size")', function() {
