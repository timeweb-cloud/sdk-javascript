...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.HttpResourceConfig();
  });
  ...
  describe('HttpResourceConfig', function() {
    it('should create an instance of HttpResourceConfig', function() {
      // uncomment below and update the code to test HttpResourceConfig
      //var instance = new TimewebCloudApi.HttpResourceConfig();
      //expect(instance).to.be.a(TimewebCloudApi.HttpResourceConfig);
    });
