...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.PresetsDbs();
  });
  ...
  describe('PresetsDbs', function() {
    it('should create an instance of PresetsDbs', function() {
      // uncomment below and update the code to test PresetsDbs
      //var instance = new TimewebCloudApi.PresetsDbs();
      //expect(instance).to.be.a(TimewebCloudApi.PresetsDbs);
    });
