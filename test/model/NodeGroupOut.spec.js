...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.NodeGroupOut();
  });
  ...
  describe('NodeGroupOut', function() {
    it('should create an instance of NodeGroupOut', function() {
      // uncomment below and update the code to test NodeGroupOut
      //var instance = new TimewebCloudApi.NodeGroupOut();
      //expect(instance).to.be.a(TimewebCloudApi.NodeGroupOut);
    });
