...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.CreateVpc();
  });
  ...
  describe('CreateVpc', function() {
    it('should create an instance of CreateVpc', function() {
      // uncomment below and update the code to test CreateVpc
      //var instance = new TimewebCloudApi.CreateVpc();
      //expect(instance).to.be.a(TimewebCloudApi.CreateVpc);
    });
