...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.CreateFloatingIp();
  });
  ...
  describe('CreateFloatingIp', function() {
    it('should create an instance of CreateFloatingIp', function() {
      // uncomment below and update the code to test CreateFloatingIp
      //var instance = new TimewebCloudApi.CreateFloatingIp();
      //expect(instance).to.be.a(TimewebCloudApi.CreateFloatingIp);
    });
