...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.CreateDb();
  });
  ...
  describe('CreateDb', function() {
    it('should create an instance of CreateDb', function() {
      // uncomment below and update the code to test CreateDb
      //var instance = new TimewebCloudApi.CreateDb();
      //expect(instance).to.be.a(TimewebCloudApi.CreateDb);
    });
