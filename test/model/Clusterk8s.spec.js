...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.Clusterk8s();
  });
  ...
  describe('Clusterk8s', function() {
    it('should create an instance of Clusterk8s', function() {
      // uncomment below and update the code to test Clusterk8s
      //var instance = new TimewebCloudApi.Clusterk8s();
      //expect(instance).to.be.a(TimewebCloudApi.Clusterk8s);
    });
    ...
    it('should have the property ha (base name: "ha")', function() {
      // uncomment below and update the code to test the property ha
      //var instance = new TimewebCloudApi.Clusterk8s();
      //expect(instance).to.be();
    });
