...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.CreateServerConfiguration();
  });
  ...
  describe('CreateServerConfiguration', function() {
    it('should create an instance of CreateServerConfiguration', function() {
      // uncomment below and update the code to test CreateServerConfiguration
      //var instance = new TimewebCloudApi.CreateServerConfiguration();
      //expect(instance).to.be.a(TimewebCloudApi.CreateServerConfiguration);
    });
