...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.ClusterOut();
  });
  ...
  describe('ClusterOut', function() {
    it('should create an instance of ClusterOut', function() {
      // uncomment below and update the code to test ClusterOut
      //var instance = new TimewebCloudApi.ClusterOut();
      //expect(instance).to.be.a(TimewebCloudApi.ClusterOut);
    });
