...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.PresetsStorage();
  });
  ...
  describe('PresetsStorage', function() {
    it('should create an instance of PresetsStorage', function() {
      // uncomment below and update the code to test PresetsStorage
      //var instance = new TimewebCloudApi.PresetsStorage();
      //expect(instance).to.be.a(TimewebCloudApi.PresetsStorage);
    });
