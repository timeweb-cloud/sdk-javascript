...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.NodeOut();
  });
  ...
  describe('NodeOut', function() {
    it('should create an instance of NodeOut', function() {
      // uncomment below and update the code to test NodeOut
      //var instance = new TimewebCloudApi.NodeOut();
      //expect(instance).to.be.a(TimewebCloudApi.NodeOut);
    });
