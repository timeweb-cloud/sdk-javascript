...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.ClusterInOidcProvider();
  });
  ...
  describe('ClusterInOidcProvider', function() {
    it('should create an instance of ClusterInOidcProvider', function() {
      // uncomment below and update the code to test ClusterInOidcProvider
      //var instance = new TimewebCloudApi.ClusterInOidcProvider();
      //expect(instance).to.be.a(TimewebCloudApi.ClusterInOidcProvider);
    });
