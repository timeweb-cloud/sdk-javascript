...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.VdsDisksInner();
  });
  ...
  describe('VdsDisksInner', function() {
    it('should create an instance of VdsDisksInner', function() {
      // uncomment below and update the code to test VdsDisksInner
      //var instance = new TimewebCloudApi.VdsDisksInner();
      //expect(instance).to.be.a(TimewebCloudApi.VdsDisksInner);
    });
