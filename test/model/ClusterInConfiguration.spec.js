...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.ClusterInConfiguration();
  });
  ...
  describe('ClusterInConfiguration', function() {
    it('should create an instance of ClusterInConfiguration', function() {
      // uncomment below and update the code to test ClusterInConfiguration
      //var instance = new TimewebCloudApi.ClusterInConfiguration();
      //expect(instance).to.be.a(TimewebCloudApi.ClusterInConfiguration);
    });
