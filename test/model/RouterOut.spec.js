...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.RouterOut();
  });
  ...
  describe('RouterOut', function() {
    it('should create an instance of RouterOut', function() {
      // uncomment below and update the code to test RouterOut
      //var instance = new TimewebCloudApi.RouterOut();
      //expect(instance).to.be.a(TimewebCloudApi.RouterOut);
    });
