...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.NodeGroupsResponse();
  });
  ...
  describe('NodeGroupsResponse', function() {
    it('should create an instance of NodeGroupsResponse', function() {
      // uncomment below and update the code to test NodeGroupsResponse
      //var instance = new TimewebCloudApi.NodeGroupsResponse();
      //expect(instance).to.be.a(TimewebCloudApi.NodeGroupsResponse);
    });
