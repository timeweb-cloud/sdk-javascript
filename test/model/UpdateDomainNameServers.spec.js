...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.UpdateDomainNameServers();
  });
  ...
  describe('UpdateDomainNameServers', function() {
    it('should create an instance of UpdateDomainNameServers', function() {
      // uncomment below and update the code to test UpdateDomainNameServers
      //var instance = new TimewebCloudApi.UpdateDomainNameServers();
      //expect(instance).to.be.a(TimewebCloudApi.UpdateDomainNameServers);
    });
