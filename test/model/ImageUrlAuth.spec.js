...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.ImageUrlAuth();
  });
  ...
  describe('ImageUrlAuth', function() {
    it('should create an instance of ImageUrlAuth', function() {
      // uncomment below and update the code to test ImageUrlAuth
      //var instance = new TimewebCloudApi.ImageUrlAuth();
      //expect(instance).to.be.a(TimewebCloudApi.ImageUrlAuth);
    });
