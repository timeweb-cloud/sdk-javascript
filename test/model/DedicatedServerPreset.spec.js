...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.DedicatedServerPreset();
  });
  ...
  describe('DedicatedServerPreset', function() {
    it('should create an instance of DedicatedServerPreset', function() {
      // uncomment below and update the code to test DedicatedServerPreset
      //var instance = new TimewebCloudApi.DedicatedServerPreset();
      //expect(instance).to.be.a(TimewebCloudApi.DedicatedServerPreset);
    });
    ...
    it('should have the property isIpmiEnabled (base name: "is_ipmi_enabled")', function() {
      // uncomment below and update the code to test the property isIpmiEnabled
      //var instance = new TimewebCloudApi.DedicatedServerPreset();
      //expect(instance).to.be();
    });
