...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.NodeGroupResponse();
  });
  ...
  describe('NodeGroupResponse', function() {
    it('should create an instance of NodeGroupResponse', function() {
      // uncomment below and update the code to test NodeGroupResponse
      //var instance = new TimewebCloudApi.NodeGroupResponse();
      //expect(instance).to.be.a(TimewebCloudApi.NodeGroupResponse);
    });
