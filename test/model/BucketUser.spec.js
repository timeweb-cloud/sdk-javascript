...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.BucketUser();
  });
  ...
  describe('BucketUser', function() {
    it('should create an instance of BucketUser', function() {
      // uncomment below and update the code to test BucketUser
      //var instance = new TimewebCloudApi.BucketUser();
      //expect(instance).to.be.a(TimewebCloudApi.BucketUser);
    });
