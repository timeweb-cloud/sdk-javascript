...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.CreateHttpResource();
  });
  ...
  describe('CreateHttpResource', function() {
    it('should create an instance of CreateHttpResource', function() {
      // uncomment below and update the code to test CreateHttpResource
      //var instance = new TimewebCloudApi.CreateHttpResource();
      //expect(instance).to.be.a(TimewebCloudApi.CreateHttpResource);
    });
    ...
    it('should have the property deliveryDomain (base name: "delivery_domain")', function() {
      // uncomment below and update the code to test the property deliveryDomain
      //var instance = new TimewebCloudApi.CreateHttpResource();
      //expect(instance).to.be();
    });
