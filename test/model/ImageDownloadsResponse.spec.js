...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.ImageDownloadsResponse();
  });
  ...
  describe('ImageDownloadsResponse', function() {
    it('should create an instance of ImageDownloadsResponse', function() {
      // uncomment below and update the code to test ImageDownloadsResponse
      //var instance = new TimewebCloudApi.ImageDownloadsResponse();
      //expect(instance).to.be.a(TimewebCloudApi.ImageDownloadsResponse);
    });
