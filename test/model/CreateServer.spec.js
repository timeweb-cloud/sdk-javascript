...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.CreateServer();
  });
  ...
  describe('CreateServer', function() {
    it('should create an instance of CreateServer', function() {
      // uncomment below and update the code to test CreateServer
      //var instance = new TimewebCloudApi.CreateServer();
      //expect(instance).to.be.a(TimewebCloudApi.CreateServer);
    });
    ...
    it('should have the property sshKeysIds (base name: "ssh_keys_ids")', function() {
      // uncomment below and update the code to test the property sshKeysIds
      //var instance = new TimewebCloudApi.CreateServer();
      //expect(instance).to.be();
    });

    it('should have the property isLocalNetwork (base name: "is_local_network")', function() {
      // uncomment below and update the code to test the property isLocalNetwork
      //var instance = new TimewebCloudApi.CreateServer();
      //expect(instance).to.be();
    });
