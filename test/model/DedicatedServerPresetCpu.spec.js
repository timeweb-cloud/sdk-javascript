...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.DedicatedServerPresetCpu();
  });
  ...
  describe('DedicatedServerPresetCpu', function() {
    it('should create an instance of DedicatedServerPresetCpu', function() {
      // uncomment below and update the code to test DedicatedServerPresetCpu
      //var instance = new TimewebCloudApi.DedicatedServerPresetCpu();
      //expect(instance).to.be.a(TimewebCloudApi.DedicatedServerPresetCpu);
    });
