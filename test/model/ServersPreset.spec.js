...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.ServersPreset();
  });
  ...
  describe('ServersPreset', function() {
    it('should create an instance of ServersPreset', function() {
      // uncomment below and update the code to test ServersPreset
      //var instance = new TimewebCloudApi.ServersPreset();
      //expect(instance).to.be.a(TimewebCloudApi.ServersPreset);
    });
