...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.UpdateBalancer();
  });
  ...
  describe('UpdateBalancer', function() {
    it('should create an instance of UpdateBalancer', function() {
      // uncomment below and update the code to test UpdateBalancer
      //var instance = new TimewebCloudApi.UpdateBalancer();
      //expect(instance).to.be.a(TimewebCloudApi.UpdateBalancer);
    });
