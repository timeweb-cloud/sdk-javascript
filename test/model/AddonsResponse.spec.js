...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.AddonsResponse();
  });
  ...
  describe('AddonsResponse', function() {
    it('should create an instance of AddonsResponse', function() {
      // uncomment below and update the code to test AddonsResponse
      //var instance = new TimewebCloudApi.AddonsResponse();
      //expect(instance).to.be.a(TimewebCloudApi.AddonsResponse);
    });
