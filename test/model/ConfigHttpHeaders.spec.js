...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.ConfigHttpHeaders();
  });
  ...
  describe('ConfigHttpHeaders', function() {
    it('should create an instance of ConfigHttpHeaders', function() {
      // uncomment below and update the code to test ConfigHttpHeaders
      //var instance = new TimewebCloudApi.ConfigHttpHeaders();
      //expect(instance).to.be.a(TimewebCloudApi.ConfigHttpHeaders);
    });
