...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.AddGithub();
  });
  ...
  describe('AddGithub', function() {
    it('should create an instance of AddGithub', function() {
      // uncomment below and update the code to test AddGithub
      //var instance = new TimewebCloudApi.AddGithub();
      //expect(instance).to.be.a(TimewebCloudApi.AddGithub);
    });
