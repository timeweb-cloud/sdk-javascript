...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.UpdateServerConfigurator();
  });
  ...
  describe('UpdateServerConfigurator', function() {
    it('should create an instance of UpdateServerConfigurator', function() {
      // uncomment below and update the code to test UpdateServerConfigurator
      //var instance = new TimewebCloudApi.UpdateServerConfigurator();
      //expect(instance).to.be.a(TimewebCloudApi.UpdateServerConfigurator);
    });
