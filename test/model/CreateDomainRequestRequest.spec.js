...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.CreateDomainRequestRequest();
  });
  ...
  describe('CreateDomainRequestRequest', function() {
    it('should create an instance of CreateDomainRequestRequest', function() {
      // uncomment below and update the code to test CreateDomainRequestRequest
      //var instance = new TimewebCloudApi.CreateDomainRequestRequest();
      //expect(instance).to.be.a(TimewebCloudApi.CreateDomainRequestRequest);
    });
