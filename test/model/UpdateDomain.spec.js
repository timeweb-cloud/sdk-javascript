...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.UpdateDomain();
  });
  ...
  describe('UpdateDomain', function() {
    it('should create an instance of UpdateDomain', function() {
      // uncomment below and update the code to test UpdateDomain
      //var instance = new TimewebCloudApi.UpdateDomain();
      //expect(instance).to.be.a(TimewebCloudApi.UpdateDomain);
    });
