...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.DatabaseAdmin();
  });
  ...
  describe('DatabaseAdmin', function() {
    it('should create an instance of DatabaseAdmin', function() {
      // uncomment below and update the code to test DatabaseAdmin
      //var instance = new TimewebCloudApi.DatabaseAdmin();
      //expect(instance).to.be.a(TimewebCloudApi.DatabaseAdmin);
    });
