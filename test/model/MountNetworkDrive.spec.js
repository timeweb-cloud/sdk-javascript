...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.MountNetworkDrive();
  });
  ...
  describe('MountNetworkDrive', function() {
    it('should create an instance of MountNetworkDrive', function() {
      // uncomment below and update the code to test MountNetworkDrive
      //var instance = new TimewebCloudApi.MountNetworkDrive();
      //expect(instance).to.be.a(TimewebCloudApi.MountNetworkDrive);
    });
