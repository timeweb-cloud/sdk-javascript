...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.SchemasBaseError();
  });
  ...
  describe('SchemasBaseError', function() {
    it('should create an instance of SchemasBaseError', function() {
      // uncomment below and update the code to test SchemasBaseError
      //var instance = new TimewebCloudApi.SchemasBaseError();
      //expect(instance).to.be.a(TimewebCloudApi.SchemasBaseError);
    });
