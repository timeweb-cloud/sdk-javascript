...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.NetworkDrivePreset();
  });
  ...
  describe('NetworkDrivePreset', function() {
    it('should create an instance of NetworkDrivePreset', function() {
      // uncomment below and update the code to test NetworkDrivePreset
      //var instance = new TimewebCloudApi.NetworkDrivePreset();
      //expect(instance).to.be.a(TimewebCloudApi.NetworkDrivePreset);
    });
    ...
    it('should have the property costPerGb (base name: "cost_per_gb")', function() {
      // uncomment below and update the code to test the property costPerGb
      //var instance = new TimewebCloudApi.NetworkDrivePreset();
      //expect(instance).to.be();
    });
