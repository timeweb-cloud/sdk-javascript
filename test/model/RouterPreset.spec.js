...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.RouterPreset();
  });
  ...
  describe('RouterPreset', function() {
    it('should create an instance of RouterPreset', function() {
      // uncomment below and update the code to test RouterPreset
      //var instance = new TimewebCloudApi.RouterPreset();
      //expect(instance).to.be.a(TimewebCloudApi.RouterPreset);
    });
