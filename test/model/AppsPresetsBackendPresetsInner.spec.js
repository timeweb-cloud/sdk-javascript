...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.AppsPresetsBackendPresetsInner();
  });
  ...
  describe('AppsPresetsBackendPresetsInner', function() {
    it('should create an instance of AppsPresetsBackendPresetsInner', function() {
      // uncomment below and update the code to test AppsPresetsBackendPresetsInner
      //var instance = new TimewebCloudApi.AppsPresetsBackendPresetsInner();
      //expect(instance).to.be.a(TimewebCloudApi.AppsPresetsBackendPresetsInner);
    });
