...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.IssueCertificate();
  });
  ...
  describe('IssueCertificate', function() {
    it('should create an instance of IssueCertificate', function() {
      // uncomment below and update the code to test IssueCertificate
      //var instance = new TimewebCloudApi.IssueCertificate();
      //expect(instance).to.be.a(TimewebCloudApi.IssueCertificate);
    });
