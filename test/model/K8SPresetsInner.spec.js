...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.K8SPresetsInner();
  });
  ...
  describe('K8SPresetsInner', function() {
    it('should create an instance of K8SPresetsInner', function() {
      // uncomment below and update the code to test K8SPresetsInner
      //var instance = new TimewebCloudApi.K8SPresetsInner();
      //expect(instance).to.be.a(TimewebCloudApi.K8SPresetsInner);
    });
