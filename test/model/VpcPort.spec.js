...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.VpcPort();
  });
  ...
  describe('VpcPort', function() {
    it('should create an instance of VpcPort', function() {
      // uncomment below and update the code to test VpcPort
      //var instance = new TimewebCloudApi.VpcPort();
      //expect(instance).to.be.a(TimewebCloudApi.VpcPort);
    });
