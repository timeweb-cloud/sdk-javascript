...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.DatabaseCluster();
  });
  ...
  describe('DatabaseCluster', function() {
    it('should create an instance of DatabaseCluster', function() {
      // uncomment below and update the code to test DatabaseCluster
      //var instance = new TimewebCloudApi.DatabaseCluster();
      //expect(instance).to.be.a(TimewebCloudApi.DatabaseCluster);
    });
