...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.NetworkDrive();
  });
  ...
  describe('NetworkDrive', function() {
    it('should create an instance of NetworkDrive', function() {
      // uncomment below and update the code to test NetworkDrive
      //var instance = new TimewebCloudApi.NetworkDrive();
      //expect(instance).to.be.a(TimewebCloudApi.NetworkDrive);
    });
    ...
    it('should have the property serviceList (base name: "service_list")', function() {
