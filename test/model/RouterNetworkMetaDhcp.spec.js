...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.RouterNetworkMetaDhcp();
  });
  ...
  describe('RouterNetworkMetaDhcp', function() {
    it('should create an instance of RouterNetworkMetaDhcp', function() {
      // uncomment below and update the code to test RouterNetworkMetaDhcp
      //var instance = new TimewebCloudApi.RouterNetworkMetaDhcp();
      //expect(instance).to.be.a(TimewebCloudApi.RouterNetworkMetaDhcp);
    });
