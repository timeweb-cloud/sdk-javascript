...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.ConfigOriginAws();
  });
  ...
  describe('ConfigOriginAws', function() {
    it('should create an instance of ConfigOriginAws', function() {
      // uncomment below and update the code to test ConfigOriginAws
      //var instance = new TimewebCloudApi.ConfigOriginAws();
      //expect(instance).to.be.a(TimewebCloudApi.ConfigOriginAws);
    });
