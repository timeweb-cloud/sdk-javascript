...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.CreateKnowledgebase();
  });
  ...
  describe('CreateKnowledgebase', function() {
    it('should create an instance of CreateKnowledgebase', function() {
      // uncomment below and update the code to test CreateKnowledgebase
      //var instance = new TimewebCloudApi.CreateKnowledgebase();
      //expect(instance).to.be.a(TimewebCloudApi.CreateKnowledgebase);
    });
    ...
    it('should have the property dbaasPresetId (base name: "dbaas_preset_id")', function() {
      // uncomment below and update the code to test the property dbaasPresetId
      //var instance = new TimewebCloudApi.CreateKnowledgebase();
      //expect(instance).to.be();
    });
