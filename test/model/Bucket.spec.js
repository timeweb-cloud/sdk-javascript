...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.Bucket();
  });
  ...
  describe('Bucket', function() {
    it('should create an instance of Bucket', function() {
      ...
      //expect(instance).to.be.a(TimewebCloudApi.Bucket);
    });
    ...
    it('should have the property objectAmount (base name: "object_amount")', function() {
      // uncomment below and update the code to test the property objectAmount
      //var instance = new TimewebCloudApi.Bucket();
      //expect(instance).to.be();
    });
