...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.AppConfiguration();
  });
  ...
  describe('AppConfiguration', function() {
    it('should create an instance of AppConfiguration', function() {
      ...
      //var instance = new TimewebCloudApi.AppConfiguration();
      //expect(instance).to.be.a(TimewebCloudApi.AppConfiguration);
    });
    ...
    it('should have the property networkBandwidth (base name: "network_bandwidth")', function() {
