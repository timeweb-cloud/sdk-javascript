...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.AddGit();
  });
  ...
  describe('AddGit', function() {
    it('should create an instance of AddGit', function() {
      // uncomment below and update the code to test AddGit
      //var instance = new TimewebCloudApi.AddGit();
      //expect(instance).to.be.a(TimewebCloudApi.AddGit);
    });
