...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.WorkerPresetOutApi();
  });
  ...
  describe('WorkerPresetOutApi', function() {
    it('should create an instance of WorkerPresetOutApi', function() {
      // uncomment below and update the code to test WorkerPresetOutApi
      //var instance = new TimewebCloudApi.WorkerPresetOutApi();
      //expect(instance).to.be.a(TimewebCloudApi.WorkerPresetOutApi);
    });
