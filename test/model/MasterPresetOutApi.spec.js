...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.MasterPresetOutApi();
  });
  ...
  describe('MasterPresetOutApi', function() {
    it('should create an instance of MasterPresetOutApi', function() {
      // uncomment below and update the code to test MasterPresetOutApi
      //var instance = new TimewebCloudApi.MasterPresetOutApi();
      //expect(instance).to.be.a(TimewebCloudApi.MasterPresetOutApi);
    });
