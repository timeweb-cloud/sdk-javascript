...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.VpcService();
  });
  ...
  describe('VpcService', function() {
    it('should create an instance of VpcService', function() {
      // uncomment below and update the code to test VpcService
      //var instance = new TimewebCloudApi.VpcService();
      //expect(instance).to.be.a(TimewebCloudApi.VpcService);
    });
