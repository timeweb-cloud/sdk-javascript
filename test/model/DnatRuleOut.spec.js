...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.DnatRuleOut();
  });
  ...
  describe('DnatRuleOut', function() {
    it('should create an instance of DnatRuleOut', function() {
      // uncomment below and update the code to test DnatRuleOut
      //var instance = new TimewebCloudApi.DnatRuleOut();
      //expect(instance).to.be.a(TimewebCloudApi.DnatRuleOut);
    });
    ...
    it('should have the property publicPort (base name: "public_port")', function() {
