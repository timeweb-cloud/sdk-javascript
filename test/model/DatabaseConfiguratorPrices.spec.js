...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.DatabaseConfiguratorPrices();
  });
  ...
  describe('DatabaseConfiguratorPrices', function() {
    it('should create an instance of DatabaseConfiguratorPrices', function() {
      // uncomment below and update the code to test DatabaseConfiguratorPrices
      //var instance = new TimewebCloudApi.DatabaseConfiguratorPrices();
      //expect(instance).to.be.a(TimewebCloudApi.DatabaseConfiguratorPrices);
    });
