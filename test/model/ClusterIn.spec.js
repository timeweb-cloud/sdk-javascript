...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.ClusterIn();
  });
  ...
  describe('ClusterIn', function() {
    it('should create an instance of ClusterIn', function() {
      // uncomment below and update the code to test ClusterIn
      //var instance = new TimewebCloudApi.ClusterIn();
      //expect(instance).to.be.a(TimewebCloudApi.ClusterIn);
    });
    ...
    it('should have the property networkDriver (base name: "network_driver")', function() {
      // uncomment below and update the code to test the property networkDriver
      //var instance = new TimewebCloudApi.ClusterIn();
      //expect(instance).to.be();
    });

    it('should have the property isIngress (base name: "is_ingress")', function() {
      // uncomment below and update the code to test the property isIngress
      //var instance = new TimewebCloudApi.ClusterIn();
      //expect(instance).to.be();
    });

    it('should have the property isK8sDashboard (base name: "is_k8s_dashboard")', function() {
      // uncomment below and update the code to test the property isK8sDashboard
      //var instance = new TimewebCloudApi.ClusterIn();
      //expect(instance).to.be();
    });
