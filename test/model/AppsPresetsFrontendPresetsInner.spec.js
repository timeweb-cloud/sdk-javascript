...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.AppsPresetsFrontendPresetsInner();
  });
  ...
  describe('AppsPresetsFrontendPresetsInner', function() {
    it('should create an instance of AppsPresetsFrontendPresetsInner', function() {
      // uncomment below and update the code to test AppsPresetsFrontendPresetsInner
      //var instance = new TimewebCloudApi.AppsPresetsFrontendPresetsInner();
      //expect(instance).to.be.a(TimewebCloudApi.AppsPresetsFrontendPresetsInner);
    });
