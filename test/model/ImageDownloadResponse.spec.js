...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.ImageDownloadResponse();
  });
  ...
  describe('ImageDownloadResponse', function() {
    it('should create an instance of ImageDownloadResponse', function() {
      // uncomment below and update the code to test ImageDownloadResponse
      //var instance = new TimewebCloudApi.ImageDownloadResponse();
      //expect(instance).to.be.a(TimewebCloudApi.ImageDownloadResponse);
    });
