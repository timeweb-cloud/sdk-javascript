...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.UpdateAutoBackup();
  });
  ...
  describe('UpdateAutoBackup', function() {
    it('should create an instance of UpdateAutoBackup', function() {
      // uncomment below and update the code to test UpdateAutoBackup
      //var instance = new TimewebCloudApi.UpdateAutoBackup();
      //expect(instance).to.be.a(TimewebCloudApi.UpdateAutoBackup);
    });
