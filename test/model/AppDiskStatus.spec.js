...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.AppDiskStatus();
  });
  ...
  describe('AppDiskStatus', function() {
    it('should create an instance of AppDiskStatus', function() {
      // uncomment below and update the code to test AppDiskStatus
      //var instance = new TimewebCloudApi.AppDiskStatus();
      //expect(instance).to.be.a(TimewebCloudApi.AppDiskStatus);
    });
