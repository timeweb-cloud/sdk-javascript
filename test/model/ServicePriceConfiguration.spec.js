...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.ServicePriceConfiguration();
  });
  ...
  describe('ServicePriceConfiguration', function() {
    it('should create an instance of ServicePriceConfiguration', function() {
      // uncomment below and update the code to test ServicePriceConfiguration
      //var instance = new TimewebCloudApi.ServicePriceConfiguration();
      //expect(instance).to.be.a(TimewebCloudApi.ServicePriceConfiguration);
    });
