...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.RouterIn();
  });
  ...
  describe('RouterIn', function() {
    it('should create an instance of RouterIn', function() {
      // uncomment below and update the code to test RouterIn
      //var instance = new TimewebCloudApi.RouterIn();
      //expect(instance).to.be.a(TimewebCloudApi.RouterIn);
    });
    ...
    it('should have the property parentService (base name: "parent_service")', function() {
      // uncomment below and update the code to test the property parentService
      //var instance = new TimewebCloudApi.RouterIn();
      //expect(instance).to.be();
    });
