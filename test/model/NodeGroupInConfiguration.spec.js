...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.NodeGroupInConfiguration();
  });
  ...
  describe('NodeGroupInConfiguration', function() {
    it('should create an instance of NodeGroupInConfiguration', function() {
      // uncomment below and update the code to test NodeGroupInConfiguration
      //var instance = new TimewebCloudApi.NodeGroupInConfiguration();
      //expect(instance).to.be.a(TimewebCloudApi.NodeGroupInConfiguration);
    });
