...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.CreateClusterConfiguration();
  });
  ...
  describe('CreateClusterConfiguration', function() {
    it('should create an instance of CreateClusterConfiguration', function() {
      // uncomment below and update the code to test CreateClusterConfiguration
      //var instance = new TimewebCloudApi.CreateClusterConfiguration();
      //expect(instance).to.be.a(TimewebCloudApi.CreateClusterConfiguration);
    });
