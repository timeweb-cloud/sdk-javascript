...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.AddCertificate();
  });
  ...
  describe('AddCertificate', function() {
    it('should create an instance of AddCertificate', function() {
      // uncomment below and update the code to test AddCertificate
      //var instance = new TimewebCloudApi.AddCertificate();
      //expect(instance).to.be.a(TimewebCloudApi.AddCertificate);
    });
