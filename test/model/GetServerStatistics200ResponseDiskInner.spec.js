...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.GetServerStatistics200ResponseDiskInner();
  });
  ...
  describe('GetServerStatistics200ResponseDiskInner', function() {
    it('should create an instance of GetServerStatistics200ResponseDiskInner', function() {
      // uncomment below and update the code to test GetServerStatistics200ResponseDiskInner
      //var instance = new TimewebCloudApi.GetServerStatistics200ResponseDiskInner();
      //expect(instance).to.be.a(TimewebCloudApi.GetServerStatistics200ResponseDiskInner);
    });
