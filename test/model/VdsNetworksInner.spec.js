...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.VdsNetworksInner();
  });
  ...
  describe('VdsNetworksInner', function() {
    it('should create an instance of VdsNetworksInner', function() {
      // uncomment below and update the code to test VdsNetworksInner
      //var instance = new TimewebCloudApi.VdsNetworksInner();
      //expect(instance).to.be.a(TimewebCloudApi.VdsNetworksInner);
    });
