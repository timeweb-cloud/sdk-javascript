...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.AvailableNetwork();
  });
  ...
  describe('AvailableNetwork', function() {
    it('should create an instance of AvailableNetwork', function() {
      // uncomment below and update the code to test AvailableNetwork
      //var instance = new TimewebCloudApi.AvailableNetwork();
      //expect(instance).to.be.a(TimewebCloudApi.AvailableNetwork);
    });
