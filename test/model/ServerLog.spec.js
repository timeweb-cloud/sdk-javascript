...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.ServerLog();
  });
  ...
  describe('ServerLog', function() {
    it('should create an instance of ServerLog', function() {
      // uncomment below and update the code to test ServerLog
      //var instance = new TimewebCloudApi.ServerLog();
      //expect(instance).to.be.a(TimewebCloudApi.ServerLog);
    });
