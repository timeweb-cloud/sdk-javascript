...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.DocumentStatusInfoDetails();
  });
  ...
  describe('DocumentStatusInfoDetails', function() {
    it('should create an instance of DocumentStatusInfoDetails', function() {
      // uncomment below and update the code to test DocumentStatusInfoDetails
      //var instance = new TimewebCloudApi.DocumentStatusInfoDetails();
      //expect(instance).to.be.a(TimewebCloudApi.DocumentStatusInfoDetails);
    });
