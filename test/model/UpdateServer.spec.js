...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.UpdateServer();
  });
  ...
  describe('UpdateServer', function() {
    it('should create an instance of UpdateServer', function() {
      // uncomment below and update the code to test UpdateServer
      //var instance = new TimewebCloudApi.UpdateServer();
      //expect(instance).to.be.a(TimewebCloudApi.UpdateServer);
    });
