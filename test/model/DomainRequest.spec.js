...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.DomainRequest();
  });
  ...
  describe('DomainRequest', function() {
    it('should create an instance of DomainRequest', function() {
      // uncomment below and update the code to test DomainRequest
      //var instance = new TimewebCloudApi.DomainRequest();
      //expect(instance).to.be.a(TimewebCloudApi.DomainRequest);
    });
    ...
    it('should have the property domainBundleId (base name: "domain_bundle_id")', function() {
      // uncomment below and update the code to test the property domainBundleId
      //var instance = new TimewebCloudApi.DomainRequest();
      //expect(instance).to.be();
    });

    it('should have the property errorCodeTransfer (base name: "error_code_transfer")', function() {
      // uncomment below and update the code to test the property errorCodeTransfer
      //var instance = new TimewebCloudApi.DomainRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property moneySource (base name: "money_source")', function() {
      // uncomment below and update the code to test the property moneySource
      //var instance = new TimewebCloudApi.DomainRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property soonExpire (base name: "soon_expire")', function() {
      // uncomment below and update the code to test the property soonExpire
      //var instance = new TimewebCloudApi.DomainRequest();
      //expect(instance).to.be();
    });
