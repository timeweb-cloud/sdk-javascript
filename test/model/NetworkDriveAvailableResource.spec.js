...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.NetworkDriveAvailableResource();
  });
  ...
  describe('NetworkDriveAvailableResource', function() {
    it('should create an instance of NetworkDriveAvailableResource', function() {
      // uncomment below and update the code to test NetworkDriveAvailableResource
      //var instance = new TimewebCloudApi.NetworkDriveAvailableResource();
      //expect(instance).to.be.a(TimewebCloudApi.NetworkDriveAvailableResource);
    });
