...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.AddonConfigOut();
  });
  ...
  describe('AddonConfigOut', function() {
    it('should create an instance of AddonConfigOut', function() {
      // uncomment below and update the code to test AddonConfigOut
      //var instance = new TimewebCloudApi.AddonConfigOut();
      //expect(instance).to.be.a(TimewebCloudApi.AddonConfigOut);
    });
