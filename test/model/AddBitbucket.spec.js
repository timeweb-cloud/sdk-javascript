...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.AddBitbucket();
  });
  ...
  describe('AddBitbucket', function() {
    it('should create an instance of AddBitbucket', function() {
      // uncomment below and update the code to test AddBitbucket
      //var instance = new TimewebCloudApi.AddBitbucket();
      //expect(instance).to.be.a(TimewebCloudApi.AddBitbucket);
    });
