...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.UpdateInstance();
  });
  ...
  describe('UpdateInstance', function() {
    it('should create an instance of UpdateInstance', function() {
      // uncomment below and update the code to test UpdateInstance
      //var instance = new TimewebCloudApi.UpdateInstance();
      //expect(instance).to.be.a(TimewebCloudApi.UpdateInstance);
    });
