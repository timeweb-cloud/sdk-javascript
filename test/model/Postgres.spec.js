...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.Postgres();
  });
  ...
  describe('Postgres', function() {
    it('should create an instance of Postgres', function() {
      // uncomment below and update the code to test Postgres
      //var instance = new TimewebCloudApi.Postgres();
      //expect(instance).to.be.a(TimewebCloudApi.Postgres);
    });
