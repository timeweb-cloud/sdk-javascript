...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.RegistryIn();
  });
  ...
  describe('RegistryIn', function() {
    it('should create an instance of RegistryIn', function() {
      // uncomment below and update the code to test RegistryIn
      //var instance = new TimewebCloudApi.RegistryIn();
      //expect(instance).to.be.a(TimewebCloudApi.RegistryIn);
    });
