...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.RegistryOut();
  });
  ...
  describe('RegistryOut', function() {
    it('should create an instance of RegistryOut', function() {
      // uncomment below and update the code to test RegistryOut
      //var instance = new TimewebCloudApi.RegistryOut();
      //expect(instance).to.be.a(TimewebCloudApi.RegistryOut);
    });
