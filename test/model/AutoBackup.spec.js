...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.AutoBackup();
  });
  ...
  describe('AutoBackup', function() {
    it('should create an instance of AutoBackup', function() {
      // uncomment below and update the code to test AutoBackup
      //var instance = new TimewebCloudApi.AutoBackup();
      //expect(instance).to.be.a(TimewebCloudApi.AutoBackup);
    });
