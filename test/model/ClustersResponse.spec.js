...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.ClustersResponse();
  });
  ...
  describe('ClustersResponse', function() {
    it('should create an instance of ClustersResponse', function() {
      // uncomment below and update the code to test ClustersResponse
      //var instance = new TimewebCloudApi.ClustersResponse();
      //expect(instance).to.be.a(TimewebCloudApi.ClustersResponse);
    });
