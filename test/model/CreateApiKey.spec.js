...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.CreateApiKey();
  });
  ...
  describe('CreateApiKey', function() {
    it('should create an instance of CreateApiKey', function() {
      // uncomment below and update the code to test CreateApiKey
      //var instance = new TimewebCloudApi.CreateApiKey();
      //expect(instance).to.be.a(TimewebCloudApi.CreateApiKey);
    });
    ...
    it('should have the property isAbleToDelete (base name: "is_able_to_delete")', function() {
      // uncomment below and update the code to test the property isAbleToDelete
      //var instance = new TimewebCloudApi.CreateApiKey();
      //expect(instance).to.be();
    });
