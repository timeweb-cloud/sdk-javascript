...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.UpdateClusterConfiguration();
  });
  ...
  describe('UpdateClusterConfiguration', function() {
    it('should create an instance of UpdateClusterConfiguration', function() {
      // uncomment below and update the code to test UpdateClusterConfiguration
      //var instance = new TimewebCloudApi.UpdateClusterConfiguration();
      //expect(instance).to.be.a(TimewebCloudApi.UpdateClusterConfiguration);
    });
