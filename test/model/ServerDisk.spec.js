...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.ServerDisk();
  });
  ...
  describe('ServerDisk', function() {
    it('should create an instance of ServerDisk', function() {
      // uncomment below and update the code to test ServerDisk
      //var instance = new TimewebCloudApi.ServerDisk();
      //expect(instance).to.be.a(TimewebCloudApi.ServerDisk);
    });
