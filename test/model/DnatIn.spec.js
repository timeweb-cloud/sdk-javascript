...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.DnatIn();
  });
  ...
  describe('DnatIn', function() {
    it('should create an instance of DnatIn', function() {
      // uncomment below and update the code to test DnatIn
      //var instance = new TimewebCloudApi.DnatIn();
      //expect(instance).to.be.a(TimewebCloudApi.DnatIn);
    });
