...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.Balancer();
  });
  ...
  describe('Balancer', function() {
    it('should create an instance of Balancer', function() {
      // uncomment below and update the code to test Balancer
      //var instance = new TimewebCloudApi.Balancer();
      //expect(instance).to.be.a(TimewebCloudApi.Balancer);
    });
