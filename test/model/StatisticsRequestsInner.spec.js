...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.StatisticsRequestsInner();
  });
  ...
  describe('StatisticsRequestsInner', function() {
    it('should create an instance of StatisticsRequestsInner', function() {
      // uncomment below and update the code to test StatisticsRequestsInner
      //var instance = new TimewebCloudApi.StatisticsRequestsInner();
      //expect(instance).to.be.a(TimewebCloudApi.StatisticsRequestsInner);
    });
