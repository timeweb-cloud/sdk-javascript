...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.RegistryEdit();
  });
  ...
  describe('RegistryEdit', function() {
    it('should create an instance of RegistryEdit', function() {
      // uncomment below and update the code to test RegistryEdit
      //var instance = new TimewebCloudApi.RegistryEdit();
      //expect(instance).to.be.a(TimewebCloudApi.RegistryEdit);
    });
