...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.StaticRouteResponse();
  });
  ...
  describe('StaticRouteResponse', function() {
    it('should create an instance of StaticRouteResponse', function() {
      // uncomment below and update the code to test StaticRouteResponse
      //var instance = new TimewebCloudApi.StaticRouteResponse();
      //expect(instance).to.be.a(TimewebCloudApi.StaticRouteResponse);
    });
