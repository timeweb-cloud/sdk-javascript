...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.CreateDns();
  });
  ...
  describe('CreateDns', function() {
    it('should create an instance of CreateDns', function() {
      // uncomment below and update the code to test CreateDns
      //var instance = new TimewebCloudApi.CreateDns();
      //expect(instance).to.be.a(TimewebCloudApi.CreateDns);
    });
