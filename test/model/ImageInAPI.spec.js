...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.ImageInAPI();
  });
  ...
  describe('ImageInAPI', function() {
    it('should create an instance of ImageInAPI', function() {
      // uncomment below and update the code to test ImageInAPI
      //var instance = new TimewebCloudApi.ImageInAPI();
      //expect(instance).to.be.a(TimewebCloudApi.ImageInAPI);
    });
