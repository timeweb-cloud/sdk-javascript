...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.UserNode();
  });
  ...
  describe('UserNode', function() {
    it('should create an instance of UserNode', function() {
      // uncomment below and update the code to test UserNode
      //var instance = new TimewebCloudApi.UserNode();
      //expect(instance).to.be.a(TimewebCloudApi.UserNode);
    });
