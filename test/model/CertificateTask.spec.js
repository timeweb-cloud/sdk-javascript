...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.CertificateTask();
  });
  ...
  describe('CertificateTask', function() {
    it('should create an instance of CertificateTask', function() {
      // uncomment below and update the code to test CertificateTask
      //var instance = new TimewebCloudApi.CertificateTask();
      //expect(instance).to.be.a(TimewebCloudApi.CertificateTask);
    });
