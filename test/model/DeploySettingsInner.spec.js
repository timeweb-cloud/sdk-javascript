...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.DeploySettingsInner();
  });
  ...
  describe('DeploySettingsInner', function() {
    it('should create an instance of DeploySettingsInner', function() {
      // uncomment below and update the code to test DeploySettingsInner
      //var instance = new TimewebCloudApi.DeploySettingsInner();
      //expect(instance).to.be.a(TimewebCloudApi.DeploySettingsInner);
    });
