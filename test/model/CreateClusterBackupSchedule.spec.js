...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.CreateClusterBackupSchedule();
  });
  ...
  describe('CreateClusterBackupSchedule', function() {
    it('should create an instance of CreateClusterBackupSchedule', function() {
      // uncomment below and update the code to test CreateClusterBackupSchedule
      //var instance = new TimewebCloudApi.CreateClusterBackupSchedule();
      //expect(instance).to.be.a(TimewebCloudApi.CreateClusterBackupSchedule);
    });
