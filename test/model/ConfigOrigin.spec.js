...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.ConfigOrigin();
  });
  ...
  describe('ConfigOrigin', function() {
    it('should create an instance of ConfigOrigin', function() {
      // uncomment below and update the code to test ConfigOrigin
      //var instance = new TimewebCloudApi.ConfigOrigin();
      //expect(instance).to.be.a(TimewebCloudApi.ConfigOrigin);
    });
