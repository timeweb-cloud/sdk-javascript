...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.AgentModelSettings();
  });
  ...
  describe('AgentModelSettings', function() {
    it('should create an instance of AgentModelSettings', function() {
      // uncomment below and update the code to test AgentModelSettings
      //var instance = new TimewebCloudApi.AgentModelSettings();
      //expect(instance).to.be.a(TimewebCloudApi.AgentModelSettings);
    });
