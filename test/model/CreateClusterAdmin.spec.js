...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.CreateClusterAdmin();
  });
  ...
  describe('CreateClusterAdmin', function() {
    it('should create an instance of CreateClusterAdmin', function() {
      // uncomment below and update the code to test CreateClusterAdmin
      //var instance = new TimewebCloudApi.CreateClusterAdmin();
      //expect(instance).to.be.a(TimewebCloudApi.CreateClusterAdmin);
    });
