...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.BindFloatingIp();
  });
  ...
  describe('BindFloatingIp', function() {
    it('should create an instance of BindFloatingIp', function() {
      // uncomment below and update the code to test BindFloatingIp
      //var instance = new TimewebCloudApi.BindFloatingIp();
      //expect(instance).to.be.a(TimewebCloudApi.BindFloatingIp);
    });
