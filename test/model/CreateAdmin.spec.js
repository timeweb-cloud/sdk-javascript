...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.CreateAdmin();
  });
  ...
  describe('CreateAdmin', function() {
    it('should create an instance of CreateAdmin', function() {
      // uncomment below and update the code to test CreateAdmin
      //var instance = new TimewebCloudApi.CreateAdmin();
      //expect(instance).to.be.a(TimewebCloudApi.CreateAdmin);
    });
