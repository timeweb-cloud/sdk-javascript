...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.UpdateAgent();
  });
  ...
  describe('UpdateAgent', function() {
    it('should create an instance of UpdateAgent', function() {
      // uncomment below and update the code to test UpdateAgent
      //var instance = new TimewebCloudApi.UpdateAgent();
      //expect(instance).to.be.a(TimewebCloudApi.UpdateAgent);
    });
