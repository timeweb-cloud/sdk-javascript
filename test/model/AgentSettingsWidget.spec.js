...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimewebCloudApi.AgentSettingsWidget();
  });
  ...
  describe('AgentSettingsWidget', function() {
    it('should create an instance of AgentSettingsWidget', function() {
      // uncomment below and update the code to test AgentSettingsWidget
      //var instance = new TimewebCloudApi.AgentSettingsWidget();
      //expect(instance).to.be.a(TimewebCloudApi.AgentSettingsWidget);
    });

    it('should have the property whitelistDomains (base name: "whitelist_domains")', function() {
      // uncomment below and update the code to test the property whitelistDomains
      //var instance = new TimewebCloudApi.AgentSettingsWidget();
    ...
    it('should have the property chatPosition (base name: "chat_position")', function() {
      // uncomment below and update the code to test the property chatPosition
      //var instance = new TimewebCloudApi.AgentSettingsWidget();
      //expect(instance).to.be();
    });
