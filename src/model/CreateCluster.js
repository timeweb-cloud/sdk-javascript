...
/**
 * The CreateCluster model module.
 * @module model/CreateCluster
 * @version 1.0.0
 */
class CreateCluster {
    /**
    ...
    /**
     * Constructs a <code>CreateCluster</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateCluster} obj Optional instance to populate.
     * @return {module:model/CreateCluster} The populated <code>CreateCluster</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateCluster();
            ...
            if (data.hasOwnProperty('instance')) {
                obj['instance'] = CreateClusterInstance.constructFromObject(data['instance']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCluster</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCluster</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateCluster.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['admin']) { // data not null
          CreateClusterAdmin.validateJSON(data['admin']);
        }
        // validate the optional field `instance`
        if (data['instance']) { // data not null
          CreateClusterInstance.validateJSON(data['instance']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/CreateClusterAdmin} admin
 */
CreateCluster.prototype['admin'] = undefined;

/**
 * @member {module:model/CreateClusterInstance} instance
 */
