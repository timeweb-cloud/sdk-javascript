...
/**
 * The BucketDiskStats model module.
 * @module model/BucketDiskStats
 * @version 1.0.0
 */
class BucketDiskStats {
    /**
    ...
    /**
     * Constructs a <code>BucketDiskStats</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BucketDiskStats} obj Optional instance to populate.
     * @return {module:model/BucketDiskStats} The populated <code>BucketDiskStats</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BucketDiskStats();
    ...
    /**
     * Validates the JSON data with respect to <code>BucketDiskStats</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BucketDiskStats</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BucketDiskStats.RequiredProperties) {
            if (!data[property]) {
...
export default BucketDiskStats;
