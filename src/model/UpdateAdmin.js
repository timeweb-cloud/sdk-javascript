...
/**
 * The UpdateAdmin model module.
 * @module model/UpdateAdmin
 * @version 1.0.0
 */
class UpdateAdmin {
    /**
     * Constructs a new <code>UpdateAdmin</code>.
     * @alias module:model/UpdateAdmin
     */
    constructor() { 
        
        UpdateAdmin.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateAdmin</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateAdmin} obj Optional instance to populate.
     * @return {module:model/UpdateAdmin} The populated <code>UpdateAdmin</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateAdmin</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
 ...
 */
UpdateAdmin.prototype['password'] = undefined;

/**
 * Список привилегий пользователя базы данных
 * @member {Array.<module:model/UpdateAdmin.PrivilegesEnum>} privileges
 */
UpdateAdmin.prototype['privileges'] = undefined;
