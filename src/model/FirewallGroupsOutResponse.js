...
/**
 * The FirewallGroupsOutResponse model module.
 * @module model/FirewallGroupsOutResponse
 * @version 1.0.0
 */
class FirewallGroupsOutResponse {
     ...
     */
    static initialize(obj, meta, groups) { 
        obj['meta'] = meta;
        obj['groups'] = groups;
    }

    /**
     * Constructs a <code>FirewallGroupsOutResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FirewallGroupsOutResponse} obj Optional instance to populate.
     * @return {module:model/FirewallGroupsOutResponse} The populated <code>FirewallGroupsOutResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FirewallGroupsOutResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>FirewallGroupsOutResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FirewallGroupsOutResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FirewallGroupsOutResponse.RequiredProperties) {
            if (!data[property]) {
...
export default FirewallGroupsOutResponse;
