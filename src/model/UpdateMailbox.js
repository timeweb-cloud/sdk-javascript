 ...
 * @module model/UpdateMailbox
 * @version 1.0.0
 */
class UpdateMailbox {
    /**
     * Constructs a new <code>UpdateMailbox</code>.
     * Изменение почтового ящика
     * @alias module:model/UpdateMailbox
     */
    constructor() { 
        
        UpdateMailbox.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateMailbox</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateMailbox} obj Optional instance to populate.
     * @return {module:model/UpdateMailbox} The populated <code>UpdateMailbox</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateMailbox</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateMailbox</code>.
     */
 ...
 */
UpdateMailbox.prototype['comment'] = undefined;

/**
 * Пароль почтового ящика
 * @member {String} password
 */
UpdateMailbox.prototype['password'] = undefined;
