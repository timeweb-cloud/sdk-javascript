 ...
 * @module model/CreateDatabaseBackup409Response
 * @version 1.0.0
 */
class CreateDatabaseBackup409Response {
    /**
     * Constructs a new <code>CreateDatabaseBackup409Response</code>.
     * @alias module:model/CreateDatabaseBackup409Response
    ...
    constructor(statusCode, errorCode, responseId) { 
        ...
        CreateDatabaseBackup409Response.initialize(this, statusCode, errorCode, responseId);
    }
    ...
    /**
     * Constructs a <code>CreateDatabaseBackup409Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateDatabaseBackup409Response} obj Optional instance to populate.
     * @return {module:model/CreateDatabaseBackup409Response} The populated <code>CreateDatabaseBackup409Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateDatabaseBackup409Response();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateDatabaseBackup409Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateDatabaseBackup409Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateDatabaseBackup409Response.RequiredProperties) {
            if (!data[property]) {
...
CreateDatabaseBackup409Response.RequiredProperties = ["status_code", "error_code", "response_id"];
 ...
 */
CreateDatabaseBackup409Response.prototype['error_code'] = undefined;

/**
 * Идентификатор запроса, который можно указывать при обращении в службу технической поддержки, чтобы помочь определить проблему.
 * @member {String} response_id
 */
CreateDatabaseBackup409Response.prototype['response_id'] = undefined;
...
export default CreateDatabaseBackup409Response;
