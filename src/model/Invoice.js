...
class Invoice {
     ...
     * @param moneySource {module:model/Invoice.MoneySourceEnum} Тип создаваемой заявки.
     * @param paymentType {module:model/Invoice.PaymentTypeEnum} Тип платежной системы.
     * @param payerId {Number} Идентификационный номер плательщика
     */
    constructor(moneySource, paymentType, payerId) { 
        
        Invoice.initialize(this, moneySource, paymentType, payerId);
    }
     ...
     */
    static initialize(obj, moneySource, paymentType, payerId) { 
        obj['money_source'] = moneySource;
        obj['payment_type'] = paymentType;
        obj['payer_id'] = payerId;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('payer_id')) {
                obj['payer_id'] = ApiClient.convertToType(data['payer_id'], 'Number');
            }
        }
        return obj;
    }
...
Invoice.RequiredProperties = ["money_source", "payment_type", "payer_id"];

/**
 * Тип создаваемой заявки.
 * @member {module:model/Invoice.MoneySourceEnum} money_source
 */
Invoice.prototype['money_source'] = undefined;

/**
 * Идентификатор администратора, на которого зарегистрирован домен.
 * @member {Number} person_id
 */
Invoice.prototype['person_id'] = undefined;

/**
 * Тип платежной системы.
 * @member {module:model/Invoice.PaymentTypeEnum} payment_type
 */
Invoice.prototype['payment_type'] = undefined;

/**
 * Идентификационный номер плательщика
 * @member {Number} payer_id
 */
Invoice.prototype['payer_id'] = undefined;
