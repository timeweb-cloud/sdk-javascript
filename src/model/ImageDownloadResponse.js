 ...
 * @module model/ImageDownloadResponse
 * @version 1.0.0
 */
class ImageDownloadResponse {
    ...
    /**
     * Constructs a <code>ImageDownloadResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImageDownloadResponse} obj Optional instance to populate.
     * @return {module:model/ImageDownloadResponse} The populated <code>ImageDownloadResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImageDownloadResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ImageDownloadResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImageDownloadResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ImageDownloadResponse.RequiredProperties) {
            if (!data[property]) {
