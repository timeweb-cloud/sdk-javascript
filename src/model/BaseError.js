...
class BaseError {
    ...
    constructor(statusCode, errorCode, message) { 
        ...
        BaseError.initialize(this, statusCode, errorCode, message);
    }
...
BaseError.RequiredProperties = ["status_code", "error_code", "message"];

/**
 * @member {Number} status_code
 */
BaseError.prototype['status_code'] = undefined;
 ...
 */
BaseError.prototype['response_id'] = undefined;
