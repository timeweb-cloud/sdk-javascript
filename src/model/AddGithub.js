...
/**
 * The AddGithub model module.
 * @module model/AddGithub
 * @version 1.0.0
 */
class AddGithub {
    /**
    ...
    constructor(providerType, providerToken) { 
        ...
        AddGithub.initialize(this, providerType, providerToken);
    }
    ...
    /**
     * Constructs a <code>AddGithub</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddGithub} obj Optional instance to populate.
     * @return {module:model/AddGithub} The populated <code>AddGithub</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddGithub();
    ...
    /**
     * Validates the JSON data with respect to <code>AddGithub</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddGithub</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddGithub.RequiredProperties) {
            if (!data[property]) {
...
AddGithub.RequiredProperties = ["provider_type", "provider_token"];

/**
 * Тип провайдера.
 * @member {module:model/AddGithub.ProviderTypeEnum} provider_type
 */
