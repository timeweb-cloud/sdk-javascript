 ...
 * @module model/GetAuthAccessSettings200Response
 * @version 1.0.0
 */
class GetAuthAccessSettings200Response {
    /**
     * Constructs a new <code>GetAuthAccessSettings200Response</code>.
    ...
    /**
     * Constructs a <code>GetAuthAccessSettings200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetAuthAccessSettings200Response} obj Optional instance to populate.
     * @return {module:model/GetAuthAccessSettings200Response} The populated <code>GetAuthAccessSettings200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetAuthAccessSettings200Response();

            if (data.hasOwnProperty('is_ip_restrictions_enabled')) {
                obj['is_ip_restrictions_enabled'] = ApiClient.convertToType(data['is_ip_restrictions_enabled'], 'Boolean');
            }
            if (data.hasOwnProperty('is_country_restrictions_enabled')) {
    ...
    /**
     * Validates the JSON data with respect to <code>GetAuthAccessSettings200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetAuthAccessSettings200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetAuthAccessSettings200Response.RequiredProperties) {
            if (!data[property]) {
 ...
 * @member {Boolean} is_ip_restrictions_enabled
 */
GetAuthAccessSettings200Response.prototype['is_ip_restrictions_enabled'] = undefined;

/**
 * Это логическое значение, которое показывает, включено ли ограничение доступа по стране.
 * @member {Boolean} is_country_restrictions_enabled
 */
...
export default GetAuthAccessSettings200Response;
