...
class UpdatePerson {
     ...
     * @param address {String} Почтовый адрес администратора.
     ...
     */
    constructor(address, email, phone, postcode) { 
        
        UpdatePerson.initialize(this, address, email, phone, postcode);
    }
     ...
     */
    static initialize(obj, address, email, phone, postcode) { 
        obj['address'] = address;
        obj['email'] = email;
        obj['phone'] = phone;
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePerson</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePerson</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdatePerson.RequiredProperties) {
            if (!data[property]) {
...
UpdatePerson.RequiredProperties = ["address", "email", "phone", "postcode"];

/**
 * Почтовый адрес администратора.
 * @member {String} address
 */
UpdatePerson.prototype['address'] = undefined;
 ...
 */
UpdatePerson.prototype['postcode'] = undefined;
