...
class FloatingIp {
    ...
    static validateJSON(data) {
        ...
        for (const property of FloatingIp.RequiredProperties) {
            if (!data[property]) {
 ...
 * @member {String} ip
 */
FloatingIp.prototype['ip'] = undefined;

/**
 * Это логическое значение, которое показывает, включена ли защита от DDoS.
 * @member {Boolean} is_ddos_guard
 */
FloatingIp.prototype['is_ddos_guard'] = undefined;

/**
 * @member {module:model/AvailabilityZone} availability_zone
 */
FloatingIp.prototype['availability_zone'] = undefined;

/**
 * Тип ресурса.
 * @member {module:model/FloatingIp.ResourceTypeEnum} resource_type
 */
FloatingIp.prototype['resource_type'] = undefined;

/**
 * Id ресурса.
 * @member {Number} resource_id
 */
FloatingIp.prototype['resource_id'] = undefined;

/**
 * Комментарий
 * @member {String} comment
 */
FloatingIp.prototype['comment'] = undefined;

/**
 * Запись имени узла.
 * @member {String} ptr
 */
FloatingIp.prototype['ptr'] = undefined;
