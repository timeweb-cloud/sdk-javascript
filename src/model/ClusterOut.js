...
class ClusterOut {
     ...
     * @param id {Number} Уникальный идентификатор кластера
     ...
     * @param ha {Boolean} Описание появится позже
     * @param k8sVersion {String} Версия Kubernetes
     * @param networkDriver {String} Используемый сетевой драйвер
     ...
     */
    constructor(id, name, createdAt, status, description, ha, k8sVersion, networkDriver, ingress, presetId) { 
        
        ClusterOut.initialize(this, id, name, createdAt, status, description, ha, k8sVersion, networkDriver, ingress, presetId);
    }
     ...
     */
    static initialize(obj, id, name, createdAt, status, description, ha, k8sVersion, networkDriver, ingress, presetId) { 
        obj['id'] = id;
        obj['name'] = name;
...
ClusterOut.RequiredProperties = ["id", "name", "created_at", "status", "description", "ha", "k8s_version", "network_driver", "ingress", "preset_id"];
 ...
 * @member {Boolean} ha
 */
ClusterOut.prototype['ha'] = undefined;
