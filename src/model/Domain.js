...
class Domain {
     ...
     * @param id {Number} Уникальный идентификатор домена.
     ...
     * @param personId {Number} Идентификатор администратора, на которого зарегистрирован домен.
     * @param premiumProlongCost {Number} Стоимость премиального домена.
     * @param provider {String} Идентификатор регистратора домена.
     ...
     * @param tldId {Number} Идентификатор доменной зоны.
     */
