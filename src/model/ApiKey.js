...
class ApiKey {
     ...
     * @param isAbleToDelete {Boolean} Это логическое значение, которое показывает, можно ли удалять управляемые сервисы при помощи данного токена без подтверждения через Телеграм, когда это подтверждение включено.
     */
    constructor(id, createdAt, name, expiredAt, isAbleToDelete) { 
        
        ApiKey.initialize(this, id, createdAt, name, expiredAt, isAbleToDelete);
    }
     ...
     */
    static initialize(obj, id, createdAt, name, expiredAt, isAbleToDelete) { 
        obj['id'] = id;
        obj['created_at'] = createdAt;
        obj['name'] = name;
        obj['expired_at'] = expiredAt;
        obj['is_able_to_delete'] = isAbleToDelete;
    }
...
ApiKey.RequiredProperties = ["id", "created_at", "name", "expired_at", "is_able_to_delete"];
 ...
 */
ApiKey.prototype['expired_at'] = undefined;
 ...
 */
ApiKey.prototype['is_able_to_delete'] = undefined;
