...
import UpdateClusterV2DiskAutoscaling from './UpdateClusterV2DiskAutoscaling';
import UpdateClusterV2MaintenanceSlot from './UpdateClusterV2MaintenanceSlot';

/**
 * The UpdateClusterV2 model module.
 * @module model/UpdateClusterV2
 * @version 1.0.0
 */
class UpdateClusterV2 {
    /**
     * Constructs a new <code>UpdateClusterV2</code>.
     * Изменение кластера базы данных (v2)
     * @alias module:model/UpdateClusterV2
     */
    constructor() { 
        
        UpdateClusterV2.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateClusterV2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateClusterV2} obj Optional instance to populate.
     * @return {module:model/UpdateClusterV2} The populated <code>UpdateClusterV2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateClusterV2();
            ...
            if (data.hasOwnProperty('maintenance_slot')) {
                obj['maintenance_slot'] = UpdateClusterV2MaintenanceSlot.constructFromObject(data['maintenance_slot']);
            }
            if (data.hasOwnProperty('disk_autoscaling')) {
                obj['disk_autoscaling'] = UpdateClusterV2DiskAutoscaling.constructFromObject(data['disk_autoscaling']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateClusterV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateClusterV2</code>.
     */
    static validateJSON(data) {
        ...
        if (data['maintenance_slot']) { // data not null
          UpdateClusterV2MaintenanceSlot.validateJSON(data['maintenance_slot']);
        }
        // validate the optional field `disk_autoscaling`
        if (data['disk_autoscaling']) { // data not null
          UpdateClusterV2DiskAutoscaling.validateJSON(data['disk_autoscaling']);
        }
 ...
 * @member {String} name
 */
UpdateClusterV2.prototype['name'] = undefined;

/**
 * ID тарифа. Нельзя передавать вместе с `configuration`
 * @member {Number} preset_id
 */
UpdateClusterV2.prototype['preset_id'] = undefined;

/**
 * @member {module:model/UpdateClusterConfiguration} configuration
 */
UpdateClusterV2.prototype['configuration'] = undefined;

/**
 * @member {module:model/Mysql} config_parameters
 */
UpdateClusterV2.prototype['config_parameters'] = undefined;

/**
 * Тип хеширования базы данных (mysql | postgres).
 * @member {module:model/UpdateClusterV2.HashTypeEnum} hash_type
 */
UpdateClusterV2.prototype['hash_type'] = undefined;

/**
 * Описание кластера базы данных
 * @member {String} description
 */
UpdateClusterV2.prototype['description'] = undefined;

/**
 * Доступность публичного IP-адреса
 * @member {Boolean} is_enabled_public_network
 */
UpdateClusterV2.prototype['is_enabled_public_network'] = undefined;

/**
 * Использование публичного IPv6-адреса.
 * @member {Boolean} is_enabled_public_ipv6
 */
UpdateClusterV2.prototype['is_enabled_public_ipv6'] = undefined;
 ...
 */
UpdateClusterV2.prototype['floating_ip'] = undefined;
 ...
 */
UpdateClusterV2.prototype['is_secure_connection_enable'] = undefined;

/**
 * @member {module:model/UpdateClusterV2MaintenanceSlot} maintenance_slot
 */
UpdateClusterV2.prototype['maintenance_slot'] = undefined;

/**
 * @member {module:model/UpdateClusterV2DiskAutoscaling} disk_autoscaling
 */
UpdateClusterV2.prototype['disk_autoscaling'] = undefined;
...
export default UpdateClusterV2;
