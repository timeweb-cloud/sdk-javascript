...
/**
 * The CreateKey201Response model module.
 * @module model/CreateKey201Response
 * @version 1.0.0
 */
class CreateKey201Response {
    /**
    ...
    /**
     * Constructs a <code>CreateKey201Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateKey201Response} obj Optional instance to populate.
     * @return {module:model/CreateKey201Response} The populated <code>CreateKey201Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateKey201Response();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateKey201Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateKey201Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateKey201Response.RequiredProperties) {
            if (!data[property]) {
...
export default CreateKey201Response;
