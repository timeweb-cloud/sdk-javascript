...
/**
 * The AddCdnCertificate422Response model module.
 * @module model/AddCdnCertificate422Response
 * @version 1.0.0
 */
class AddCdnCertificate422Response {
    /**
     * Constructs a new <code>AddCdnCertificate422Response</code>.
     * @alias module:model/AddCdnCertificate422Response
    ...
    constructor(statusCode, errorCode, responseId) { 
        ...
        AddCdnCertificate422Response.initialize(this, statusCode, errorCode, responseId);
    }
    ...
    /**
     * Constructs a <code>AddCdnCertificate422Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddCdnCertificate422Response} obj Optional instance to populate.
     * @return {module:model/AddCdnCertificate422Response} The populated <code>AddCdnCertificate422Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddCdnCertificate422Response();
    ...
    /**
     * Validates the JSON data with respect to <code>AddCdnCertificate422Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddCdnCertificate422Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddCdnCertificate422Response.RequiredProperties) {
            if (!data[property]) {
...
AddCdnCertificate422Response.RequiredProperties = ["status_code", "error_code", "response_id"];

/**
 * Короткий идентификатор, соответствующий возвращаемому коду состояния HTTP.
 * @member {Number} status_code
 */
AddCdnCertificate422Response.prototype['status_code'] = undefined;
...
export default AddCdnCertificate422Response;
