 ...
 * @module model/GetFinances400Response
 * @version 1.0.0
 */
class GetFinances400Response {
    /**
     * Constructs a new <code>GetFinances400Response</code>.
     * @alias module:model/GetFinances400Response
    ...
    constructor(statusCode, errorCode, responseId) { 
        ...
        GetFinances400Response.initialize(this, statusCode, errorCode, responseId);
    }
    ...
    /**
     * Constructs a <code>GetFinances400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetFinances400Response} obj Optional instance to populate.
     * @return {module:model/GetFinances400Response} The populated <code>GetFinances400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetFinances400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>GetFinances400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetFinances400Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetFinances400Response.RequiredProperties) {
            if (!data[property]) {
...
GetFinances400Response.RequiredProperties = ["status_code", "error_code", "response_id"];
...
export default GetFinances400Response;
