 ...
 * @module model/UpdateBalancer
 * @version 1.0.0
 */
class UpdateBalancer {
    /**
     * Constructs a new <code>UpdateBalancer</code>.
     * @alias module:model/UpdateBalancer
     */
    constructor() { 
        
        UpdateBalancer.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateBalancer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateBalancer} obj Optional instance to populate.
     * @return {module:model/UpdateBalancer} The populated <code>UpdateBalancer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateBalancer();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateBalancer</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateBalancer</code>.
     */
 ...
 */
UpdateBalancer.prototype['is_keepalive'] = undefined;

/**
 * Протокол.
 * @member {module:model/UpdateBalancer.ProtoEnum} proto
 */
UpdateBalancer.prototype['proto'] = undefined;

/**
 * Порт балансировщика.
 * @member {Number} port
 */
UpdateBalancer.prototype['port'] = undefined;

/**
 * Адрес балансировщика.
 * @member {String} path
 */
UpdateBalancer.prototype['path'] = undefined;

/**
 * Интервал проверки.
 * @member {Number} inter
 */
UpdateBalancer.prototype['inter'] = undefined;

/**
 * Таймаут ответа балансировщика.
 * @member {Number} timeout
 */
UpdateBalancer.prototype['timeout'] = undefined;

/**
 * Порог количества ошибок.
 * @member {Number} fall
 */
UpdateBalancer.prototype['fall'] = undefined;
 ...
 */
UpdateBalancer.prototype['maxconn'] = undefined;

/**
 * Таймаут подключения.
 * @member {Number} connect_timeout
 */
UpdateBalancer.prototype['connect_timeout'] = undefined;

/**
 * Таймаут клиента.
 * @member {Number} client_timeout
 */
UpdateBalancer.prototype['client_timeout'] = undefined;

/**
 * Таймаут сервера.
 * @member {Number} server_timeout
 */
UpdateBalancer.prototype['server_timeout'] = undefined;
