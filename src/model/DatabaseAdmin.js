...
import DatabaseAdminInstancesInner from './DatabaseAdminInstancesInner';

/**
 * The DatabaseAdmin model module.
 * @module model/DatabaseAdmin
 * @version 1.0.0
 */
class DatabaseAdmin {
    /**
     * Constructs a new <code>DatabaseAdmin</code>.
     * Пользователь базы данных
     * @alias module:model/DatabaseAdmin
     * @param id {Number} Уникальный идентификатор для каждого экземпляра пользователя базы данных. Автоматически генерируется при создании.
    ...
    /**
     * Constructs a <code>DatabaseAdmin</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DatabaseAdmin} obj Optional instance to populate.
     * @return {module:model/DatabaseAdmin} The populated <code>DatabaseAdmin</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DatabaseAdmin();
    ...
    /**
     * Validates the JSON data with respect to <code>DatabaseAdmin</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatabaseAdmin</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DatabaseAdmin.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['instances']) { // data not null
            ...
            for (const item of data['instances']) {
                DatabaseAdminInstancesInner.validateJSON(item);
            };
        }
 ...
 * @member {String} login
 */
DatabaseAdmin.prototype['login'] = undefined;
 ...
 */
DatabaseAdmin.prototype['instances'] = undefined;
