...
/**
 * The UpdateServerOSBootModeRequest model module.
 * @module model/UpdateServerOSBootModeRequest
 * @version 1.0.0
 */
class UpdateServerOSBootModeRequest {
    /**
    ...
    constructor(bootMode) { 
        ...
        UpdateServerOSBootModeRequest.initialize(this, bootMode);
    }
     ...
     */
    static initialize(obj, bootMode) { 
        obj['boot_mode'] = bootMode;
    }

    /**
     * Constructs a <code>UpdateServerOSBootModeRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateServerOSBootModeRequest} obj Optional instance to populate.
     * @return {module:model/UpdateServerOSBootModeRequest} The populated <code>UpdateServerOSBootModeRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateServerOSBootModeRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateServerOSBootModeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateServerOSBootModeRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateServerOSBootModeRequest.RequiredProperties) {
            if (!data[property]) {
 ...
 * @readonly
 */
UpdateServerOSBootModeRequest['BootModeEnum'] = {
...
export default UpdateServerOSBootModeRequest;
