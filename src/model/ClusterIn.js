...
class ClusterIn {
     ...
     * @param networkDriver {String} Тип используемого сетевого драйвера в кластере
     * @param ingress {Boolean} Логическое значение, которое показывает, использовать ли Ingress в кластере
     * @param presetId {Number} Идентификатор тарифа мастер-ноды
     */
    constructor(name, ha, k8sVersion, networkDriver, ingress, presetId) { 
        
        ClusterIn.initialize(this, name, ha, k8sVersion, networkDriver, ingress, presetId);
    }
     ...
     */
    static initialize(obj, name, ha, k8sVersion, networkDriver, ingress, presetId) { 
        obj['name'] = name;
        obj['ha'] = ha;
...
ClusterIn.RequiredProperties = ["name", "ha", "k8s_version", "network_driver", "ingress", "preset_id"];
 ...
 * @member {Boolean} ha
 */
ClusterIn.prototype['ha'] = undefined;
 ...
 */
ClusterIn.prototype['ingress'] = undefined;
