...
/**
 * The ClusterIn model module.
 * @module model/ClusterIn
 * @version 1.0.0
 */
class ClusterIn {
    /**
     * Constructs a new <code>ClusterIn</code>.
     * @alias module:model/ClusterIn
    ...
    /**
     * Constructs a <code>ClusterIn</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClusterIn} obj Optional instance to populate.
     * @return {module:model/ClusterIn} The populated <code>ClusterIn</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClusterIn();
            ...
            if (data.hasOwnProperty('is_ingress')) {
                obj['is_ingress'] = ApiClient.convertToType(data['is_ingress'], 'Boolean');
            }
            if (data.hasOwnProperty('is_k8s_dashboard')) {
                obj['is_k8s_dashboard'] = ApiClient.convertToType(data['is_k8s_dashboard'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ClusterIn</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClusterIn</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ClusterIn.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['worker_groups']) { // data not null
            ...
            if (!Array.isArray(data['worker_groups'])) {
                throw new Error("Expected the field `worker_groups` to be an array in the JSON data but got " + data['worker_groups']);
            }
            // validate the optional field `worker_groups` (array)
            for (const item of data['worker_groups']) {
                NodeGroupIn.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 * @member {String} name
 */
ClusterIn.prototype['name'] = undefined;
 ...
 */
ClusterIn.prototype['k8s_version'] = undefined;

/**
 * Зона доступности
 * @member {module:model/ClusterIn.AvailabilityZoneEnum} availability_zone
 */
ClusterIn.prototype['availability_zone'] = undefined;

/**
 * Тип используемого сетевого драйвера в кластере
 * @member {module:model/ClusterIn.NetworkDriverEnum} network_driver
 */
ClusterIn.prototype['network_driver'] = undefined;

/**
 * Логическое значение, которое показывает, использовать ли Ingress в кластере
 * @member {Boolean} is_ingress
 */
ClusterIn.prototype['is_ingress'] = undefined;

/**
 * Логическое значение, которое показывает, использовать ли Kubernetes Dashboard в кластере
 * @member {Boolean} is_k8s_dashboard
 */
 ...
 * @member {Array.<module:model/NodeGroupIn>} worker_groups
 */
ClusterIn.prototype['worker_groups'] = undefined;

/**
 * ID приватной сети
 * @member {String} network_id
 */
ClusterIn.prototype['network_id'] = undefined;
 ...
 * @readonly
 */
ClusterIn['AvailabilityZoneEnum'] = {
