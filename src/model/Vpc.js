...
class Vpc {
     ...
     * @param id {String} Идентификатор сети.
    ...
    static validateJSON(data) {
        ...
        for (const property of Vpc.RequiredProperties) {
            if (!data[property]) {
 ...
 * @member {String} name
 */
Vpc.prototype['name'] = undefined;

/**
 * Маска подсети.
 * @member {String} subnet_v4
 */
Vpc.prototype['subnet_v4'] = undefined;

/**
 * Локация сети.
 * @member {module:model/Vpc.LocationEnum} location
 */
Vpc.prototype['location'] = undefined;

/**
 * Дата создания сети.
 * @member {Date} created_at
 */
Vpc.prototype['created_at'] = undefined;
