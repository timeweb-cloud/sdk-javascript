...
class Commit {
     ...
     * @param sha {String} Хэш коммита.
     * @param createdAt {Date} Значение времени, указанное в комбинированном формате даты и времени ISO8601, которое представляет, когда был создан коммит.
     * @param message {String} Сообщение коммита.
     */
    constructor(sha, createdAt, message) { 
        
        Commit.initialize(this, sha, createdAt, message);
    }
     ...
     */
    static initialize(obj, sha, createdAt, message) { 
        obj['sha'] = sha;
...
Commit.RequiredProperties = ["sha", "created_at", "message"];
