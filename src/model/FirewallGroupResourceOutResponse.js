 ...
 * @module model/FirewallGroupResourceOutResponse
 * @version 1.0.0
 */
class FirewallGroupResourceOutResponse {
    ...
    /**
     * Constructs a <code>FirewallGroupResourceOutResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FirewallGroupResourceOutResponse} obj Optional instance to populate.
     * @return {module:model/FirewallGroupResourceOutResponse} The populated <code>FirewallGroupResourceOutResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FirewallGroupResourceOutResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>FirewallGroupResourceOutResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FirewallGroupResourceOutResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FirewallGroupResourceOutResponse.RequiredProperties) {
            if (!data[property]) {
...
export default FirewallGroupResourceOutResponse;
