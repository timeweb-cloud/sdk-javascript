...
class GetProjects200Response {
     ...
     */
    constructor(projects, meta) { 
        
        GetProjects200Response.initialize(this, projects, meta);
    }
     ...
     */
    static initialize(obj, projects, meta) { 
...
GetProjects200Response.RequiredProperties = ["projects", "meta"];
