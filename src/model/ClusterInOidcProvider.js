...
/**
 * The ClusterInOidcProvider model module.
 * @module model/ClusterInOidcProvider
 * @version 1.0.0
 */
class ClusterInOidcProvider {
    /**
     * Constructs a new <code>ClusterInOidcProvider</code>.
     * OIDC-провайдер
     * @alias module:model/ClusterInOidcProvider
    ...
    constructor(name, issuerUrl, clientId) { 
        ...
        ClusterInOidcProvider.initialize(this, name, issuerUrl, clientId);
    }
    ...
    /**
     * Constructs a <code>ClusterInOidcProvider</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClusterInOidcProvider} obj Optional instance to populate.
     * @return {module:model/ClusterInOidcProvider} The populated <code>ClusterInOidcProvider</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClusterInOidcProvider();
    ...
    /**
     * Validates the JSON data with respect to <code>ClusterInOidcProvider</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClusterInOidcProvider</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ClusterInOidcProvider.RequiredProperties) {
            if (!data[property]) {
...
ClusterInOidcProvider.RequiredProperties = ["name", "issuer_url", "client_id"];

/**
 * Название создаваемого подключения. Используется только для идентификации и не влияет на остальные параметры
 * @member {String} name
 */
ClusterInOidcProvider.prototype['name'] = undefined;
...
export default ClusterInOidcProvider;
