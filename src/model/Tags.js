...
class Tags {
     ...
     */
    constructor(tag, digest, size) { 
        
        Tags.initialize(this, tag, digest, size);
    }
     ...
     */
    static initialize(obj, tag, digest, size) { 
        obj['tag'] = tag;
        obj['digest'] = digest;
        obj['size'] = size;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of Tags.RequiredProperties) {
            if (!data[property]) {
...
Tags.RequiredProperties = ["tag", "digest", "size"];

/**
 * Тег
 * @member {String} tag
 */
Tags.prototype['tag'] = undefined;

/**
 * Digest
 * @member {String} digest
 */
Tags.prototype['digest'] = undefined;

/**
 * Размер
 * @member {Number} size
 */
Tags.prototype['size'] = undefined;
