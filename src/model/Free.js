...
/**
 * The Free model module.
 * @module model/Free
 * @version 1.0.0
 */
class Free {
    /**
     * Constructs a new <code>Free</code>.
     * Обновление заявки на перенос домена
     * @alias module:model/Free
     * @param moneySource {module:model/Free.MoneySourceEnum} Тип создаваемой заявки.
     * @param authCode {String} Код авторизации для переноса домена.
     */
    constructor(moneySource, authCode) { 
        
        Free.initialize(this, moneySource, authCode);
    }
     ...
     */
    static initialize(obj, moneySource, authCode) { 
        obj['money_source'] = moneySource;
        obj['auth_code'] = authCode;
    }

    /**
     * Constructs a <code>Free</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Free} obj Optional instance to populate.
     * @return {module:model/Free} The populated <code>Free</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Free</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Free</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Free.RequiredProperties) {
            if (!data[property]) {
...
Free.RequiredProperties = ["money_source", "auth_code"];

/**
 * Тип создаваемой заявки.
 * @member {module:model/Free.MoneySourceEnum} money_source
 */
Free.prototype['money_source'] = undefined;

/**
 * ID администратора, на которого зарегистрирован домен.
 * @member {Number} person_id
 */
Free.prototype['person_id'] = undefined;

/**
 * Код авторизации для переноса домена.
 * @member {String} auth_code
 */
Free.prototype['auth_code'] = undefined;
