...
import UpdateServerConfigurator from './UpdateServerConfigurator';

/**
 * The UpdateServer model module.
 * @module model/UpdateServer
 * @version 1.0.0
 */
class UpdateServer {
    /**
     * Constructs a new <code>UpdateServer</code>.
     * @alias module:model/UpdateServer
     */
    constructor() { 
        
        UpdateServer.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateServer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateServer} obj Optional instance to populate.
     * @return {module:model/UpdateServer} The populated <code>UpdateServer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateServer();

            if (data.hasOwnProperty('configurator')) {
                obj['configurator'] = UpdateServerConfigurator.constructFromObject(data['configurator']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateServer</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateServer</code>.
     */
    static validateJSON(data) {
        // validate the optional field `configurator`
        if (data['configurator']) { // data not null
          UpdateServerConfigurator.validateJSON(data['configurator']);
        }
 ...
 */
UpdateServer.prototype['avatar_id'] = undefined;

/**
 * Комментарий к облачному серверу. Максимальная длина — 255 символов.
 * @member {String} comment
 */
UpdateServer.prototype['comment'] = undefined;
