...
/**
 * The ResourceTransfer model module.
 * @module model/ResourceTransfer
 * @version 1.0.0
 */
class ResourceTransfer {
    ...
    constructor(toProject, resourceId, resourceType) { 
        ...
        ResourceTransfer.initialize(this, toProject, resourceId, resourceType);
    }
     ...
     */
    static initialize(obj, toProject, resourceId, resourceType) { 
        obj['to_project'] = toProject;
        obj['resource_id'] = resourceId;
        obj['resource_type'] = resourceType;
    }

    /**
     * Constructs a <code>ResourceTransfer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResourceTransfer} obj Optional instance to populate.
     * @return {module:model/ResourceTransfer} The populated <code>ResourceTransfer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResourceTransfer();

            if (data.hasOwnProperty('to_project')) {
                obj['to_project'] = ApiClient.convertToType(data['to_project'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ResourceTransfer</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResourceTransfer</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ResourceTransfer.RequiredProperties) {
            if (!data[property]) {
 ...
 * @member {module:model/ResourceTransfer.ResourceTypeEnum} resource_type
 */
ResourceTransfer.prototype['resource_type'] = undefined;
 ...
 * @readonly
 */
ResourceTransfer['ResourceTypeEnum'] = {
