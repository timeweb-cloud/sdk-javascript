...
class Backup {
     ...
     * @param id {Number} Идентификатор резервной копии.
     * @param name {String} Название резервной копии.
     * @param comment {String} Комментарий.
     * @param createdAt {Date} Дата создания.
     * @param status {module:model/Backup.StatusEnum} Статус бэкапа.
     * @param size {Number} Размер резервной копии (Мб).
     * @param type {module:model/Backup.TypeEnum} Тип бэкапа.
    ...
    constructor(id, name, comment, createdAt, status, size, type, progress) { 
        ...
        Backup.initialize(this, id, name, comment, createdAt, status, size, type, progress);
    }
...
Backup.RequiredProperties = ["id", "name", "comment", "created_at", "status", "size", "type", "progress"];
 ...
 */
Backup.prototype['comment'] = undefined;
 ...
 * @member {Number} size
 */
Backup.prototype['size'] = undefined;
 ...
 */
Backup.prototype['progress'] = undefined;
