...
class CreateStorageRequest {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateStorageRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateStorageRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateStorageRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateStorageRequest.RequiredProperties) {
            if (!data[property]) {
...
/**
 * Тип хранилища.
 * @member {module:model/CreateStorageRequest.TypeEnum} type
 */
...
export default CreateStorageRequest;
