...
/**
 * The Balancer model module.
 * @module model/Balancer
 * @version 1.0.0
 */
class Balancer {
    /**
     * Constructs a new <code>Balancer</code>.
     * Балансировщик
     * @alias module:model/Balancer
     * @param id {Number} Уникальный идентификатор для каждого экземпляра балансировщика. Автоматически генерируется при создании.
     * @param algo {module:model/Balancer.AlgoEnum} Алгоритм переключений балансировщика.
     * @param createdAt {Date} Значение времени, указанное в комбинированном формате даты и времени ISO8601, которое представляет, когда был создан балансировщик.
     * @param fall {Number} Порог количества ошибок.
     * @param inter {Number} Интервал проверки.
     * @param ip {String} IP-адрес сетевого интерфейса IPv4.
     * @param localIp {String} Локальный IP-адрес сетевого интерфейса IPv4.
     * @param isKeepalive {Boolean} Это логическое значение, которое показывает, выдает ли балансировщик сигнал о проверке жизнеспособности.
     * @param name {String} Удобочитаемое имя, установленное для балансировщика.
     * @param path {String} Адрес балансировщика.
    ...
    /**
     * Constructs a <code>Balancer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Balancer} obj Optional instance to populate.
     * @return {module:model/Balancer} The populated <code>Balancer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Balancer();
            ...
            if (data.hasOwnProperty('fall')) {
                obj['fall'] = ApiClient.convertToType(data['fall'], 'Number');
            }
            if (data.hasOwnProperty('inter')) {
                obj['inter'] = ApiClient.convertToType(data['inter'], 'Number');
            }
            ...
            if (data.hasOwnProperty('is_keepalive')) {
                obj['is_keepalive'] = ApiClient.convertToType(data['is_keepalive'], 'Boolean');
            }
            ...
            if (data.hasOwnProperty('proto')) {
                obj['proto'] = ApiClient.convertToType(data['proto'], 'String');
            }
            ...
            if (data.hasOwnProperty('is_ssl')) {
                obj['is_ssl'] = ApiClient.convertToType(data['is_ssl'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Balancer</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Balancer</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Balancer.RequiredProperties) {
            if (!data[property]) {
        ...
        // ensure the json data is a string
        if (data['proto'] && !(typeof data['proto'] === 'string' || data['proto'] instanceof String)) {
            throw new Error("Expected the field `proto` to be a primitive type in the JSON string but got " + data['proto']);
        }
        // ensure the json data is a string
 ...
 * @member {module:model/Balancer.AlgoEnum} algo
 */
Balancer.prototype['algo'] = undefined;
 ...
 */
Balancer.prototype['created_at'] = undefined;

/**
 * Порог количества ошибок.
 * @member {Number} fall
 */
Balancer.prototype['fall'] = undefined;

/**
 * Интервал проверки.
 * @member {Number} inter
 */
Balancer.prototype['inter'] = undefined;

/**
 * IP-адрес сетевого интерфейса IPv4.
 * @member {String} ip
 */
Balancer.prototype['ip'] = undefined;

/**
 * Локальный IP-адрес сетевого интерфейса IPv4.
 * @member {String} local_ip
 */
Balancer.prototype['local_ip'] = undefined;

/**
 * Это логическое значение, которое показывает, выдает ли балансировщик сигнал о проверке жизнеспособности.
 * @member {Boolean} is_keepalive
 */
Balancer.prototype['is_keepalive'] = undefined;

/**
 * Удобочитаемое имя, установленное для балансировщика.
 * @member {String} name
 */
Balancer.prototype['name'] = undefined;

/**
 * Адрес балансировщика.
 * @member {String} path
 */
Balancer.prototype['path'] = undefined;

/**
 * Порт балансировщика.
 * @member {Number} port
 */
Balancer.prototype['port'] = undefined;

/**
 * Протокол.
 * @member {module:model/Balancer.ProtoEnum} proto
 */
Balancer.prototype['proto'] = undefined;
 ...
 */
Balancer.prototype['preset_id'] = undefined;

/**
 * Это логическое значение, которое показывает, требуется ли перенаправление на SSL.
 * @member {Boolean} is_ssl
 */
Balancer.prototype['is_ssl'] = undefined;

/**
 * Статус балансировщика.
 * @member {module:model/Balancer.StatusEnum} status
 */
Balancer.prototype['status'] = undefined;

/**
 * Это логическое значение, которое показывает, сохраняется ли сессия.
 * @member {Boolean} is_sticky
 */
Balancer.prototype['is_sticky'] = undefined;
 ...
 * @member {Boolean} is_use_proxy
 */
Balancer.prototype['is_use_proxy'] = undefined;

/**
 * @member {Array.<module:model/Rule>} rules
 */
Balancer.prototype['rules'] = undefined;
...
/**
 * Allowed values for the <code>algo</code> property.
 * @enum {String}
 * @readonly
 */
Balancer['AlgoEnum'] = {
...
/**
 * Allowed values for the <code>proto</code> property.
 * @enum {String}
 * @readonly
 */
Balancer['ProtoEnum'] = {
