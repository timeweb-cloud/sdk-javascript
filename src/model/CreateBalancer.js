...
/**
 * The CreateBalancer model module.
 * @module model/CreateBalancer
 * @version 1.0.0
 */
class CreateBalancer {
     ...
     * @param proto {module:model/CreateBalancer.ProtoEnum} Протокол.
    ...
    constructor(name, algo, isSticky, isUseProxy, isSsl, isKeepalive, proto, port, path, inter, timeout, fall, rise, presetId) { 
        ...
        CreateBalancer.initialize(this, name, algo, isSticky, isUseProxy, isSsl, isKeepalive, proto, port, path, inter, timeout, fall, rise, presetId);
    }
     ...
     */
    static initialize(obj, name, algo, isSticky, isUseProxy, isSsl, isKeepalive, proto, port, path, inter, timeout, fall, rise, presetId) { 
        obj['name'] = name;
        obj['algo'] = algo;
    ...
    /**
     * Constructs a <code>CreateBalancer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateBalancer} obj Optional instance to populate.
     * @return {module:model/CreateBalancer} The populated <code>CreateBalancer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateBalancer();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateBalancer</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateBalancer</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateBalancer.RequiredProperties) {
            if (!data[property]) {
 ...
 */
CreateBalancer.prototype['is_keepalive'] = undefined;

/**
 * Протокол.
 * @member {module:model/CreateBalancer.ProtoEnum} proto
 */
CreateBalancer.prototype['proto'] = undefined;

/**
 * Порт балансировщика.
 * @member {Number} port
 */
CreateBalancer.prototype['port'] = undefined;

/**
 * Адрес балансировщика.
 * @member {String} path
 */
CreateBalancer.prototype['path'] = undefined;

/**
 * Интервал проверки.
 * @member {Number} inter
 */
CreateBalancer.prototype['inter'] = undefined;

/**
 * Таймаут ответа балансировщика.
 * @member {Number} timeout
 */
CreateBalancer.prototype['timeout'] = undefined;

/**
 * Порог количества ошибок.
 * @member {Number} fall
 */
CreateBalancer.prototype['fall'] = undefined;
