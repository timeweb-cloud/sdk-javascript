...
/**
 * The GetImage404Response model module.
 * @module model/GetImage404Response
 * @version 1.0.0
 */
class GetImage404Response {
    /**
     * Constructs a new <code>GetImage404Response</code>.
     * @alias module:model/GetImage404Response
    ...
    constructor(statusCode, errorCode, responseId) { 
        ...
        GetImage404Response.initialize(this, statusCode, errorCode, responseId);
    }
    ...
    /**
     * Constructs a <code>GetImage404Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetImage404Response} obj Optional instance to populate.
     * @return {module:model/GetImage404Response} The populated <code>GetImage404Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetImage404Response();
    ...
    /**
     * Validates the JSON data with respect to <code>GetImage404Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetImage404Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetImage404Response.RequiredProperties) {
            if (!data[property]) {
...
GetImage404Response.RequiredProperties = ["status_code", "error_code", "response_id"];

/**
 * Короткий идентификатор, соответствующий возвращаемому коду состояния HTTP.
 * @member {Number} status_code
 */
GetImage404Response.prototype['status_code'] = undefined;
 ...
 */
GetImage404Response.prototype['message'] = undefined;

/**
 * Краткое описание ошибки HTTP на основе статуса.
 * @member {String} error_code
 */
GetImage404Response.prototype['error_code'] = undefined;

/**
 * Идентификатор запроса, который можно указывать при обращении в службу технической поддержки, чтобы помочь определить проблему.
 * @member {String} response_id
 */
GetImage404Response.prototype['response_id'] = undefined;
...
export default GetImage404Response;
