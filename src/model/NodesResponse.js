...
class NodesResponse {
     ...
     */
    static initialize(obj, meta, nodes) { 
        obj['meta'] = meta;
        obj['nodes'] = nodes;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>NodesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NodesResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NodesResponse.RequiredProperties) {
            if (!data[property]) {
