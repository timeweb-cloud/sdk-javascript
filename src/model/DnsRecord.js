...
import DnsRecordData from './DnsRecordData';
...
class DnsRecord {
     ...
     * @param type {module:model/DnsRecord.TypeEnum} Тип DNS-записи.
     * @param data {module:model/DnsRecordData} 
     */
    constructor(type, data) { 
        
        DnsRecord.initialize(this, type, data);
    }
    ...
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
          DnsRecordData.validateJSON(data['data']);
        }
...
DnsRecord.RequiredProperties = ["type", "data"];
