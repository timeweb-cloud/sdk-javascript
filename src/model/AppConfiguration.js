...
class AppConfiguration {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('network_bandwidth')) {
                obj['network_bandwidth'] = ApiClient.convertToType(data['network_bandwidth'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AppConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AppConfiguration</code>.
     */
 ...
 * @member {Number} cpu
 */
AppConfiguration.prototype['cpu'] = undefined;

/**
 * Объем оперативной памяти (в МБ).
 * @member {Number} ram
 */
AppConfiguration.prototype['ram'] = undefined;

/**
 * Скорость сетевого канала (в Мбит/с).
 * @member {Number} network_bandwidth
 */
AppConfiguration.prototype['network_bandwidth'] = undefined;

/**
 * Частота процессора (в ГГц).
 * @member {String} cpu_frequency
 */
AppConfiguration.prototype['cpu_frequency'] = undefined;

/**
 * Тип диска.
 * @member {module:model/AppConfiguration.DiskTypeEnum} disk_type
 */
AppConfiguration.prototype['disk_type'] = undefined;
