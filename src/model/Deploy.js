...
class Deploy {
     ...
     * @param appId {String} Идентификатор приложения.
     * @param commitSha {String} Хэш коммита.
     * @param id {String} Идентификатор.
     * @param startedAt {Date} Время запуска деплоя.
     * @param endedAt {Date} Время окончания деплоя. Определено для завершенных деплоев
     * @param status {module:model/DeployStatus} 
     * @param commitMsg {String} Сообщение коммита.
     */
    constructor(appId, commitSha, id, startedAt, endedAt, status, commitMsg) { 
        
        Deploy.initialize(this, appId, commitSha, id, startedAt, endedAt, status, commitMsg);
    }
     ...
     */
    static initialize(obj, appId, commitSha, id, startedAt, endedAt, status, commitMsg) { 
        obj['app_id'] = appId;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('status')) {
                obj['status'] = DeployStatus.constructFromObject(data['status']);
            }
            if (data.hasOwnProperty('commit_msg')) {
                obj['commit_msg'] = ApiClient.convertToType(data['commit_msg'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of Deploy.RequiredProperties) {
            if (!data[property]) {
        ...
        // ensure the json data is a string
        if (data['commit_msg'] && !(typeof data['commit_msg'] === 'string' || data['commit_msg'] instanceof String)) {
            throw new Error("Expected the field `commit_msg` to be a primitive type in the JSON string but got " + data['commit_msg']);
        }
...
Deploy.RequiredProperties = ["app_id", "commit_sha", "id", "started_at", "ended_at", "status", "commit_msg"];

/**
 * Идентификатор приложения.
 * @member {String} app_id
 */
Deploy.prototype['app_id'] = undefined;

/**
 * Хэш коммита.
 * @member {String} commit_sha
 */
Deploy.prototype['commit_sha'] = undefined;
 ...
 */
Deploy.prototype['started_at'] = undefined;

/**
 * Время окончания деплоя. Определено для завершенных деплоев
 * @member {Date} ended_at
 */
Deploy.prototype['ended_at'] = undefined;

/**
 * @member {module:model/DeployStatus} status
 */
Deploy.prototype['status'] = undefined;

/**
 * Сообщение коммита.
 * @member {String} commit_msg
 */
Deploy.prototype['commit_msg'] = undefined;
