...
/**
 * The CreateDb model module.
 * @module model/CreateDb
 * @version 1.0.0
 */
class CreateDb {
    /**
     * Constructs a new <code>CreateDb</code>.
    ...
    constructor(password, name, type, presetId) { 
        ...
        CreateDb.initialize(this, password, name, type, presetId);
    }
     ...
     */
    static initialize(obj, password, name, type, presetId) { 
    ...
    /**
     * Constructs a <code>CreateDb</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateDb} obj Optional instance to populate.
     * @return {module:model/CreateDb} The populated <code>CreateDb</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateDb();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateDb</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateDb</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateDb.RequiredProperties) {
            if (!data[property]) {
...
CreateDb.RequiredProperties = ["password", "name", "type", "preset_id"];

/**
 * Логин для подключения к базе данных.
 * @member {String} login
 */
CreateDb.prototype['login'] = undefined;

/**
 * Пароль для подключения к базе данных.
 * @member {String} password
 */
CreateDb.prototype['password'] = undefined;
 ...
 * @member {module:model/CreateDb.HashTypeEnum} hash_type
 */
CreateDb.prototype['hash_type'] = undefined;

/**
 * Идентификатор тарифа.
 * @member {Number} preset_id
 */
CreateDb.prototype['preset_id'] = undefined;

/**
 * @member {module:model/ConfigParameters} config_parameters
 */
CreateDb.prototype['config_parameters'] = undefined;

/**
 * @member {module:model/Network} network
 */
CreateDb.prototype['network'] = undefined;
