...
import SshKeyUsedByInner from './SshKeyUsedByInner';
...
class SshKey {
     ...
     * @param id {Number} Уникальный идентификатор SSH-ключа
    ...
    constructor(id, name, body, createdAt, usedBy) { 
        ...
        SshKey.initialize(this, id, name, body, createdAt, usedBy);
    }
     ...
     */
    static initialize(obj, id, name, body, createdAt, usedBy) { 
        obj['id'] = id;
        obj['name'] = name;
        obj['body'] = body;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('used_by')) {
                obj['used_by'] = ApiClient.convertToType(data['used_by'], [SshKeyUsedByInner]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['used_by']) { // data not null
            ...
            for (const item of data['used_by']) {
                SshKeyUsedByInner.validateJSON(item);
            };
        }
