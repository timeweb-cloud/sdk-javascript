...
class NodeCount {
    ...
    constructor(count) { 
        ...
        NodeCount.initialize(this, count);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of NodeCount.RequiredProperties) {
            if (!data[property]) {
...
NodeCount.RequiredProperties = ["count"];

/**
 * Количество нод
 * @member {Number} count
 */
NodeCount.prototype['count'] = undefined;
