...
import S3Subdomain from './S3Subdomain';

/**
 * The GetStorageSubdomains200Response model module.
 * @module model/GetStorageSubdomains200Response
 * @version 1.0.0
 */
class GetStorageSubdomains200Response {
    /**
     * Constructs a new <code>GetStorageSubdomains200Response</code>.
    ...
    /**
     * Constructs a <code>GetStorageSubdomains200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetStorageSubdomains200Response} obj Optional instance to populate.
     * @return {module:model/GetStorageSubdomains200Response} The populated <code>GetStorageSubdomains200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetStorageSubdomains200Response();

            if (data.hasOwnProperty('subdomains')) {
                obj['subdomains'] = ApiClient.convertToType(data['subdomains'], [S3Subdomain]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetStorageSubdomains200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetStorageSubdomains200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetStorageSubdomains200Response.RequiredProperties) {
            if (!data[property]) {
 ...
 */
GetStorageSubdomains200Response.prototype['subdomains'] = undefined;
...
export default GetStorageSubdomains200Response;
