...
/**
 * The UpdateRule model module.
 * @module model/UpdateRule
 * @version 1.0.0
 */
class UpdateRule {
    /**
     * Constructs a new <code>UpdateRule</code>.
     * @alias module:model/UpdateRule
     * @param balancerProto {module:model/UpdateRule.BalancerProtoEnum} Протокол балансировщика.
     * @param balancerPort {Number} Порт балансировщика.
     * @param serverProto {module:model/UpdateRule.ServerProtoEnum} Протокол сервера.
     * @param serverPort {Number} Порт сервера.
     */
    constructor(balancerProto, balancerPort, serverProto, serverPort) { 
        
        UpdateRule.initialize(this, balancerProto, balancerPort, serverProto, serverPort);
    }
    ...
    /**
     * Constructs a <code>UpdateRule</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateRule} obj Optional instance to populate.
     * @return {module:model/UpdateRule} The populated <code>UpdateRule</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateRule();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateRule</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateRule</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateRule.RequiredProperties) {
            if (!data[property]) {
...
UpdateRule.RequiredProperties = ["balancer_proto", "balancer_port", "server_proto", "server_port"];

/**
 * Протокол балансировщика.
 * @member {module:model/UpdateRule.BalancerProtoEnum} balancer_proto
 */
UpdateRule.prototype['balancer_proto'] = undefined;

/**
 * Порт балансировщика.
 * @member {Number} balancer_port
 */
UpdateRule.prototype['balancer_port'] = undefined;

/**
 * Протокол сервера.
 * @member {module:model/UpdateRule.ServerProtoEnum} server_proto
 */
UpdateRule.prototype['server_proto'] = undefined;

/**
 * Порт сервера.
 * @member {Number} server_port
 */
UpdateRule.prototype['server_port'] = undefined;
