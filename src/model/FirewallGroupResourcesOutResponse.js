...
/**
 * The FirewallGroupResourcesOutResponse model module.
 * @module model/FirewallGroupResourcesOutResponse
 * @version 1.0.0
 */
class FirewallGroupResourcesOutResponse {
     ...
     */
    static initialize(obj, meta, resources) { 
        obj['meta'] = meta;
        obj['resources'] = resources;
    }

    /**
     * Constructs a <code>FirewallGroupResourcesOutResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FirewallGroupResourcesOutResponse} obj Optional instance to populate.
     * @return {module:model/FirewallGroupResourcesOutResponse} The populated <code>FirewallGroupResourcesOutResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FirewallGroupResourcesOutResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>FirewallGroupResourcesOutResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FirewallGroupResourcesOutResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FirewallGroupResourcesOutResponse.RequiredProperties) {
            if (!data[property]) {
...
export default FirewallGroupResourcesOutResponse;
