...
class Repository {
     ...
     * @param id {String} Идентификатор репозитория.
     * @param name {String} Имя репозитория.
     * @param fullName {String} Полное имя репозитория.
     * @param url {String} Ссылка на репозиторий.
     * @param isPrivate {Boolean} Является ли репозиторий приватным.
     * @param isAllowedWebhook {Boolean} Доступно ли создание вебхука для функции автодеплойя.
     */
    constructor(id, name, fullName, url, isPrivate, isAllowedWebhook) { 
        
        Repository.initialize(this, id, name, fullName, url, isPrivate, isAllowedWebhook);
    }
     ...
     */
    static initialize(obj, id, name, fullName, url, isPrivate, isAllowedWebhook) { 
        obj['id'] = id;
        obj['name'] = name;
        obj['full_name'] = fullName;
        obj['url'] = url;
        obj['is_private'] = isPrivate;
        obj['is_allowed_webhook'] = isAllowedWebhook;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('is_allowed_webhook')) {
                obj['is_allowed_webhook'] = ApiClient.convertToType(data['is_allowed_webhook'], 'Boolean');
            }
        }
        return obj;
    }
...
Repository.RequiredProperties = ["id", "name", "full_name", "url", "is_private", "is_allowed_webhook"];
 ...
 * @member {Boolean} is_allowed_webhook
 */
Repository.prototype['is_allowed_webhook'] = undefined;
