...
/**
 * The AddGitlab model module.
 * @module model/AddGitlab
 * @version 1.0.0
 */
class AddGitlab {
    /**
    ...
    constructor(providerType, providerToken) { 
        ...
        AddGitlab.initialize(this, providerType, providerToken);
    }
     ...
     */
    static initialize(obj, providerType, providerToken) { 
        obj['provider_type'] = providerType;
        obj['provider_token'] = providerToken;
    }

    /**
     * Constructs a <code>AddGitlab</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddGitlab} obj Optional instance to populate.
     * @return {module:model/AddGitlab} The populated <code>AddGitlab</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddGitlab();
    ...
    /**
     * Validates the JSON data with respect to <code>AddGitlab</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddGitlab</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddGitlab.RequiredProperties) {
            if (!data[property]) {
...
AddGitlab.RequiredProperties = ["provider_type", "provider_token"];

/**
 * Тип провайдера.
 * @member {module:model/AddGitlab.ProviderTypeEnum} provider_type
 */
