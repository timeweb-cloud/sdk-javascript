 ...
 * @module model/GetDatabaseAutoBackupsSettings200Response
 * @version 1.0.0
 */
class GetDatabaseAutoBackupsSettings200Response {
    /**
    ...
    /**
     * Constructs a <code>GetDatabaseAutoBackupsSettings200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetDatabaseAutoBackupsSettings200Response} obj Optional instance to populate.
     * @return {module:model/GetDatabaseAutoBackupsSettings200Response} The populated <code>GetDatabaseAutoBackupsSettings200Response</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>GetDatabaseAutoBackupsSettings200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDatabaseAutoBackupsSettings200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetDatabaseAutoBackupsSettings200Response.RequiredProperties) {
            if (!data[property]) {
...
export default GetDatabaseAutoBackupsSettings200Response;
