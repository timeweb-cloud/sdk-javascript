 ...
 * @module model/CreateProject
 * @version 1.0.0
 */
class CreateProject {
    /**
     * Constructs a new <code>CreateProject</code>.
     * @alias module:model/CreateProject
     * @param name {String} Удобочитаемое имя проекта. Максимальная длина — 255 символов.
     */
    constructor(name) { 
     ...
     * @param {module:model/CreateProject} obj Optional instance to populate.
     * @return {module:model/CreateProject} The populated <code>CreateProject</code> instance.
     */
