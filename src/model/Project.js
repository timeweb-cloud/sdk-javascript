...
class Project {
     ...
     * @param id {Number} ID для каждого проекта. Автоматически генерируется при создании.
     * @param accountId {String} ID пользователя.
     * @param avatarId {String} ID аватара пользователя. Описание методов работы с аватарами появится позднее.
     * @param description {String} Описание проекта.
     * @param name {String} Удобочитаемое имя проекта.
     * @param isDefault {Boolean} Это логическое значение, которое показывает, выбран ли проект по умолчанию для создания новых сущностей.
     */
    constructor(id, accountId, avatarId, description, name, isDefault) { 
        
        Project.initialize(this, id, accountId, avatarId, description, name, isDefault);
    }
     ...
     */
    static initialize(obj, id, accountId, avatarId, description, name, isDefault) { 
        obj['id'] = id;
...
Project.RequiredProperties = ["id", "account_id", "avatar_id", "description", "name", "is_default"];
 ...
 */
Project.prototype['is_default'] = undefined;
