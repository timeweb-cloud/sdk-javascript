 ...
 * @module model/GetServerStatistics200Response
 * @version 1.0.0
 */
class GetServerStatistics200Response {
    /**
    ...
    /**
     * Constructs a <code>GetServerStatistics200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetServerStatistics200Response} obj Optional instance to populate.
     * @return {module:model/GetServerStatistics200Response} The populated <code>GetServerStatistics200Response</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>GetServerStatistics200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetServerStatistics200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetServerStatistics200Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['network_traffic']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['network_traffic'])) {
                throw new Error("Expected the field `network_traffic` to be an array in the JSON data but got " + data['network_traffic']);
            }
...
export default GetServerStatistics200Response;
