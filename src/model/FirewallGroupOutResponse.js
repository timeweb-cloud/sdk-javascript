 ...
 * @module model/FirewallGroupOutResponse
 * @version 1.0.0
 */
class FirewallGroupOutResponse {
    ...
    constructor(group) { 
        ...
        FirewallGroupOutResponse.initialize(this, group);
    }
    ...
    /**
     * Constructs a <code>FirewallGroupOutResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FirewallGroupOutResponse} obj Optional instance to populate.
     * @return {module:model/FirewallGroupOutResponse} The populated <code>FirewallGroupOutResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FirewallGroupOutResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>FirewallGroupOutResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FirewallGroupOutResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FirewallGroupOutResponse.RequiredProperties) {
            if (!data[property]) {
...
export default FirewallGroupOutResponse;
