 ...
 * @module model/PresetsDbs
 * @version 1.0.0
 */
class PresetsDbs {
    /**
     * Constructs a new <code>PresetsDbs</code>.
     * @alias module:model/PresetsDbs
     */
    constructor() { 
        
        PresetsDbs.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PresetsDbs</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PresetsDbs} obj Optional instance to populate.
     * @return {module:model/PresetsDbs} The populated <code>PresetsDbs</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PresetsDbs();
    ...
    /**
     * Validates the JSON data with respect to <code>PresetsDbs</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PresetsDbs</code>.
     */
 ...
 * @member {Number} id
 */
PresetsDbs.prototype['id'] = undefined;

/**
 * Описание тарифа.
 * @member {String} description
 */
PresetsDbs.prototype['description'] = undefined;
 ...
 * @member {Number} price
 */
PresetsDbs.prototype['price'] = undefined;

/**
 * Географическое расположение тарифа.
 * @member {module:model/PresetsDbs.LocationEnum} location
 */
