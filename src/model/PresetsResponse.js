...
class PresetsResponse {
     ...
     */
    static initialize(obj, meta, k8sPresets) { 
        obj['meta'] = meta;
        obj['k8s_presets'] = k8sPresets;
    }

    /**
     * Constructs a <code>PresetsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PresetsResponse} obj Optional instance to populate.
     * @return {module:model/PresetsResponse} The populated <code>PresetsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PresetsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>PresetsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PresetsResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PresetsResponse.RequiredProperties) {
            if (!data[property]) {
...
export default PresetsResponse;
