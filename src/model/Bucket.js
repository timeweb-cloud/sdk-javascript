...
class Bucket {
     ...
     * @param id {Number} Уникальный идентификатор для каждого экземпляра хранилища. Автоматически генерируется при создании.
     ...
     * @param presetId {Number} Идентификатор тарифа хранилища.
