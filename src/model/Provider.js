...
class Provider {
     ...
     * @param providerId {String} Идентификатор провайдера.
     * @param login {String} Логин пользователя.
     * @param providerType {module:model/Providers} 
     */
    constructor(providerId, login, providerType) { 
        
        Provider.initialize(this, providerId, login, providerType);
    }
     ...
     */
    static initialize(obj, providerId, login, providerType) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('provider_type')) {
                obj['provider_type'] = Providers.constructFromObject(data['provider_type']);
            }
        }
        return obj;
    }
...
Provider.RequiredProperties = ["provider_id", "login", "provider_type"];

/**
 * Идентификатор провайдера.
 * @member {String} provider_id
 */
Provider.prototype['provider_id'] = undefined;

/**
 * Логин пользователя.
 * @member {String} login
 */
Provider.prototype['login'] = undefined;

/**
 * @member {module:model/Providers} provider_type
 */
Provider.prototype['provider_type'] = undefined;
