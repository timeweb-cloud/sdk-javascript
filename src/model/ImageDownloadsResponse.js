...
/**
 * The ImageDownloadsResponse model module.
 * @module model/ImageDownloadsResponse
 * @version 1.0.0
 */
class ImageDownloadsResponse {
     ...
     */
    static initialize(obj, meta, downloads) { 
        obj['meta'] = meta;
        obj['downloads'] = downloads;
    }

    /**
     * Constructs a <code>ImageDownloadsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImageDownloadsResponse} obj Optional instance to populate.
     * @return {module:model/ImageDownloadsResponse} The populated <code>ImageDownloadsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImageDownloadsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ImageDownloadsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImageDownloadsResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ImageDownloadsResponse.RequiredProperties) {
            if (!data[property]) {
...
export default ImageDownloadsResponse;
