...
import GetModels200ResponseMeta from './GetModels200ResponseMeta';
...
class GetModels200Response {
     ...
     * @param meta {module:model/GetModels200ResponseMeta} 
     */
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = GetModels200ResponseMeta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['meta']) { // data not null
          GetModels200ResponseMeta.validateJSON(data['meta']);
        }
...
/**
 * @member {module:model/GetModels200ResponseMeta} meta
 */
