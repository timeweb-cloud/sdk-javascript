...
/**
 * The CreateApp model module.
 * @module model/CreateApp
 * @version 1.0.0
 */
class CreateApp {
    /**
     * Constructs a new <code>CreateApp</code>.
     * @alias module:model/CreateApp
     * @param providerId {String} Уникальный идентификатор провайдера.
     * @param type {module:model/CreateApp.TypeEnum} Тип приложения.
     * @param repositoryId {String} Уникальный идентификатор репозитория.
     * @param buildCmd {String} Команда сборки приложения.
     * @param branchName {String} Название ветки репозитория из которой необходимо собрать приложение.
     ...
     */
    constructor(providerId, type, repositoryId, buildCmd, branchName, isAutoDeploy, commitSha, name, comment, presetId, framework) { 
        
        CreateApp.initialize(this, providerId, type, repositoryId, buildCmd, branchName, isAutoDeploy, commitSha, name, comment, presetId, framework);
    }
     ...
     */
    static initialize(obj, providerId, type, repositoryId, buildCmd, branchName, isAutoDeploy, commitSha, name, comment, presetId, framework) { 
    ...
    /**
     * Constructs a <code>CreateApp</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateApp} obj Optional instance to populate.
     * @return {module:model/CreateApp} The populated <code>CreateApp</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateApp();
            ...
            if (data.hasOwnProperty('repository_id')) {
                obj['repository_id'] = ApiClient.convertToType(data['repository_id'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateApp</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateApp</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateApp.RequiredProperties) {
            if (!data[property]) {
        ...
        // ensure the json data is a string
        if (data['repository_id'] && !(typeof data['repository_id'] === 'string' || data['repository_id'] instanceof String)) {
            throw new Error("Expected the field `repository_id` to be a primitive type in the JSON string but got " + data['repository_id']);
        }
        // ensure the json data is a string
...
CreateApp.RequiredProperties = ["provider_id", "type", "repository_id", "build_cmd", "branch_name", "is_auto_deploy", "commit_sha", "name", "comment", "preset_id", "framework"];

/**
 * Уникальный идентификатор провайдера.
 * @member {String} provider_id
 */
CreateApp.prototype['provider_id'] = undefined;

/**
 * Тип приложения.
 * @member {module:model/CreateApp.TypeEnum} type
 */
CreateApp.prototype['type'] = undefined;

/**
 * Уникальный идентификатор репозитория.
 * @member {String} repository_id
 */
CreateApp.prototype['repository_id'] = undefined;

/**
 * Команда сборки приложения.
 * @member {String} build_cmd
 */
CreateApp.prototype['build_cmd'] = undefined;

/**
 * Переменные окружения приложения. Объект с ключами и значениями типа string.
 * @member {Object} envs
 */
CreateApp.prototype['envs'] = undefined;

/**
 * Название ветки репозитория из которой необходимо собрать приложение.
 * @member {String} branch_name
 */
CreateApp.prototype['branch_name'] = undefined;

/**
 * Автоматический деплой.
 * @member {Boolean} is_auto_deploy
 */
CreateApp.prototype['is_auto_deploy'] = undefined;

/**
 * Хэш коммита из которого необходимо собрать приложение.
 * @member {String} commit_sha
 */
CreateApp.prototype['commit_sha'] = undefined;
 ...
 */
CreateApp.prototype['preset_id'] = undefined;

/**
 * Версия окружения.
 * @member {String} env_version
 */
CreateApp.prototype['env_version'] = undefined;
