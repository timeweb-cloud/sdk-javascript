...
class Rule {
     ...
     * @param id {Number} Уникальный идентификатор для каждого экземпляра правила для балансировщика. Автоматически генерируется при создании.
     * @param balancerProto {module:model/Rule.BalancerProtoEnum} Протокол балансировщика.
     * @param balancerPort {Number} Порт балансировщика.
     * @param serverProto {module:model/Rule.ServerProtoEnum} Протокол сервера.
     * @param serverPort {Number} Порт сервера.
     */
    constructor(id, balancerProto, balancerPort, serverProto, serverPort) { 
        
        Rule.initialize(this, id, balancerProto, balancerPort, serverProto, serverPort);
    }
     ...
     */
    static initialize(obj, id, balancerProto, balancerPort, serverProto, serverPort) { 
        obj['id'] = id;
...
Rule.RequiredProperties = ["id", "balancer_proto", "balancer_port", "server_proto", "server_port"];
 ...
 * @member {module:model/Rule.BalancerProtoEnum} balancer_proto
 */
Rule.prototype['balancer_proto'] = undefined;

/**
 * Порт балансировщика.
 * @member {Number} balancer_port
 */
Rule.prototype['balancer_port'] = undefined;

/**
 * Протокол сервера.
 * @member {module:model/Rule.ServerProtoEnum} server_proto
 */
Rule.prototype['server_proto'] = undefined;

/**
 * Порт сервера.
 * @member {Number} server_port
 */
Rule.prototype['server_port'] = undefined;
