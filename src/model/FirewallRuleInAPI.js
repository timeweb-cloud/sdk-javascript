...
/**
 * The FirewallRuleInAPI model module.
 * @module model/FirewallRuleInAPI
 * @version 1.0.0
 */
class FirewallRuleInAPI {
    /**
     * Constructs a new <code>FirewallRuleInAPI</code>.
     * @alias module:model/FirewallRuleInAPI
    ...
    constructor(direction, protocol) { 
        ...
        FirewallRuleInAPI.initialize(this, direction, protocol);
    }
    ...
    /**
     * Constructs a <code>FirewallRuleInAPI</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FirewallRuleInAPI} obj Optional instance to populate.
     * @return {module:model/FirewallRuleInAPI} The populated <code>FirewallRuleInAPI</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FirewallRuleInAPI();
    ...
    /**
     * Validates the JSON data with respect to <code>FirewallRuleInAPI</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FirewallRuleInAPI</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FirewallRuleInAPI.RequiredProperties) {
            if (!data[property]) {
...
export default FirewallRuleInAPI;
