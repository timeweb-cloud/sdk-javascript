 ...
 * @module model/NodeGroupsResponse
 * @version 1.0.0
 */
class NodeGroupsResponse {
     ...
     */
    static initialize(obj, meta, nodeGroups) { 
        obj['meta'] = meta;
        obj['node_groups'] = nodeGroups;
    }

    /**
     * Constructs a <code>NodeGroupsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NodeGroupsResponse} obj Optional instance to populate.
     * @return {module:model/NodeGroupsResponse} The populated <code>NodeGroupsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NodeGroupsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>NodeGroupsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NodeGroupsResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NodeGroupsResponse.RequiredProperties) {
            if (!data[property]) {
...
export default NodeGroupsResponse;
