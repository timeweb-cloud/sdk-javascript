...
import GetFinances404ResponseMessage from './GetFinances404ResponseMessage';
...
class GetFinances404Response {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('message')) {
                obj['message'] = GetFinances404ResponseMessage.constructFromObject(data['message']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['message']) { // data not null
          GetFinances404ResponseMessage.validateJSON(data['message']);
        }
...
/**
 * @member {module:model/GetFinances404ResponseMessage} message
 */
