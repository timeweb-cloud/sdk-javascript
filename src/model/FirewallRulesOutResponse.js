...
/**
 * The FirewallRulesOutResponse model module.
 * @module model/FirewallRulesOutResponse
 * @version 1.0.0
 */
class FirewallRulesOutResponse {
    ...
    /**
     * Constructs a <code>FirewallRulesOutResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FirewallRulesOutResponse} obj Optional instance to populate.
     * @return {module:model/FirewallRulesOutResponse} The populated <code>FirewallRulesOutResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FirewallRulesOutResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>FirewallRulesOutResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FirewallRulesOutResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FirewallRulesOutResponse.RequiredProperties) {
            if (!data[property]) {
...
export default FirewallRulesOutResponse;
