...
/**
 * The NodeOut model module.
 * @module model/NodeOut
 * @version 1.0.0
 */
class NodeOut {
    /**
     * Constructs a new <code>NodeOut</code>.
     * @alias module:model/NodeOut
     * @param id {Number} Уникальный идентификатор ноды
    ...
    /**
     * Constructs a <code>NodeOut</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NodeOut} obj Optional instance to populate.
     * @return {module:model/NodeOut} The populated <code>NodeOut</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>NodeOut</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NodeOut</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NodeOut.RequiredProperties) {
            if (!data[property]) {
 ...
 * @member {Number} id
 */
NodeOut.prototype['id'] = undefined;

/**
 * Дата и время создания ноды в формате ISO8601
 * @member {Date} created_at
 */
NodeOut.prototype['created_at'] = undefined;
 ...
 * @member {Number} cpu
 */
NodeOut.prototype['cpu'] = undefined;

/**
 * Количество памяти
 * @member {Number} ram
 */
NodeOut.prototype['ram'] = undefined;

/**
 * Количество пространства
 * @member {Number} disk
 */
NodeOut.prototype['disk'] = undefined;
