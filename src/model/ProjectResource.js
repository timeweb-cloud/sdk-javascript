...
class ProjectResource {
     ...
     * @param id {Number} Уникальный идентификатор для каждого ресурса проекта. Автоматически генерируется при создании.
     ...
     */
    constructor(id, createdAt, resourceId, project, type) { 
        
        ProjectResource.initialize(this, id, createdAt, resourceId, project, type);
    }
     ...
     */
    static initialize(obj, id, createdAt, resourceId, project, type) { 
        obj['id'] = id;
...
ProjectResource.RequiredProperties = ["id", "created_at", "resource_id", "project", "type"];
 ...
 */
ProjectResource.prototype['project'] = undefined;

/**
 * Тип ресурса проекта
 * @member {module:model/ProjectResource.TypeEnum} type
 */
