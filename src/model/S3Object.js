...
class S3Object {
     ...
     * @param type {module:model/S3Object.TypeEnum} Тип (файл или папка).
     */
    constructor(type) { 
        
        S3Object.initialize(this, type);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('checksum_algorithm')) {
                obj['checksum_algorithm'] = ApiClient.convertToType(data['checksum_algorithm'], ['String']);
            }
            if (data.hasOwnProperty('owner')) {
                obj['owner'] = S3ObjectOwner.constructFromObject(data['owner']);
            }
    ...
    static validateJSON(data) {
        ...
        if (!Array.isArray(data['checksum_algorithm'])) {
            throw new Error("Expected the field `checksum_algorithm` to be an array in the JSON data but got " + data['checksum_algorithm']);
        }
        // validate the optional field `owner`
        if (data['owner']) { // data not null
          S3ObjectOwner.validateJSON(data['owner']);
        }
        // ensure the json data is a string
...
S3Object.RequiredProperties = ["type"];
 ...
 */
S3Object.prototype['last_modified'] = undefined;
...
/**
 * Класс хранилища.
 * @member {String} storage_class
 */
S3Object.prototype['storage_class'] = undefined;

/**
 * Алгоритм
 * @member {Array.<String>} checksum_algorithm
 */
S3Object.prototype['checksum_algorithm'] = undefined;

/**
 * @member {module:model/S3ObjectOwner} owner
 */
S3Object.prototype['owner'] = undefined;

/**
 * Тип (файл или папка).
 * @member {module:model/S3Object.TypeEnum} type
 */
S3Object.prototype['type'] = undefined;
