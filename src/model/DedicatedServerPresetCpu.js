...
/**
 * The DedicatedServerPresetCpu model module.
 * @module model/DedicatedServerPresetCpu
 * @version 1.0.0
 */
class DedicatedServerPresetCpu {
    /**
     * Constructs a new <code>DedicatedServerPresetCpu</code>.
     * Объект, содержащий информацию о процессоре выделенного сервера.
     * @alias module:model/DedicatedServerPresetCpu
    ...
    /**
     * Constructs a <code>DedicatedServerPresetCpu</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DedicatedServerPresetCpu} obj Optional instance to populate.
     * @return {module:model/DedicatedServerPresetCpu} The populated <code>DedicatedServerPresetCpu</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DedicatedServerPresetCpu();
    ...
    /**
     * Validates the JSON data with respect to <code>DedicatedServerPresetCpu</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DedicatedServerPresetCpu</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DedicatedServerPresetCpu.RequiredProperties) {
            if (!data[property]) {
 ...
 */
DedicatedServerPresetCpu.prototype['description'] = undefined;

/**
 * Краткое описание характеристик процессора выделенного сервера.
 * @member {String} description_short
 */
DedicatedServerPresetCpu.prototype['description_short'] = undefined;
...
export default DedicatedServerPresetCpu;
