...
import GetKnowledgebases200ResponseMeta from './GetKnowledgebases200ResponseMeta';
...
class GetKnowledgebases200Response {
     ...
     * @param meta {module:model/GetKnowledgebases200ResponseMeta} 
     */
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = GetKnowledgebases200ResponseMeta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['meta']) { // data not null
          GetKnowledgebases200ResponseMeta.validateJSON(data['meta']);
        }
...
/**
 * @member {module:model/GetKnowledgebases200ResponseMeta} meta
 */
