...
/**
 * The GetDomainMailInfo200Response model module.
 * @module model/GetDomainMailInfo200Response
 * @version 1.0.0
 */
class GetDomainMailInfo200Response {
    /**
    ...
    /**
     * Constructs a <code>GetDomainMailInfo200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetDomainMailInfo200Response} obj Optional instance to populate.
     * @return {module:model/GetDomainMailInfo200Response} The populated <code>GetDomainMailInfo200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDomainMailInfo200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>GetDomainMailInfo200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDomainMailInfo200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetDomainMailInfo200Response.RequiredProperties) {
            if (!data[property]) {
...
export default GetDomainMailInfo200Response;
