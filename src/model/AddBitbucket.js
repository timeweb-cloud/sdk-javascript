...
/**
 * The AddBitbucket model module.
 * @module model/AddBitbucket
 * @version 1.0.0
 */
class AddBitbucket {
    /**
     * Constructs a new <code>AddBitbucket</code>.
    ...
    constructor(providerType, providerToken, login) { 
        ...
        AddBitbucket.initialize(this, providerType, providerToken, login);
    }
     ...
     */
    static initialize(obj, providerType, providerToken, login) { 
    ...
    /**
     * Constructs a <code>AddBitbucket</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddBitbucket} obj Optional instance to populate.
     * @return {module:model/AddBitbucket} The populated <code>AddBitbucket</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddBitbucket();
    ...
    /**
     * Validates the JSON data with respect to <code>AddBitbucket</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddBitbucket</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddBitbucket.RequiredProperties) {
            if (!data[property]) {
...
AddBitbucket.RequiredProperties = ["provider_type", "provider_token", "login"];

/**
 * Тип провайдера.
 * @member {module:model/AddBitbucket.ProviderTypeEnum} provider_type
 */
AddBitbucket.prototype['provider_type'] = undefined;
