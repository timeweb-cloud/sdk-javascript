...
/**
 * The ImagesOutResponse model module.
 * @module model/ImagesOutResponse
 * @version 1.0.0
 */
class ImagesOutResponse {
     ...
     */
    static initialize(obj, meta, images) { 
        obj['meta'] = meta;
        obj['images'] = images;
    }

    /**
     * Constructs a <code>ImagesOutResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImagesOutResponse} obj Optional instance to populate.
     * @return {module:model/ImagesOutResponse} The populated <code>ImagesOutResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImagesOutResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ImagesOutResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImagesOutResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ImagesOutResponse.RequiredProperties) {
            if (!data[property]) {
...
export default ImagesOutResponse;
