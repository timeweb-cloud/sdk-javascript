...
class Bonus {
     ...
     * @param moneySource {module:model/Bonus.MoneySourceEnum} Тип создаваемой заявки.
     * @param bonusId {Number} Идентификатор бонуса.
     */
    constructor(moneySource, bonusId) { 
        
        Bonus.initialize(this, moneySource, bonusId);
    }
     ...
     */
    static initialize(obj, moneySource, bonusId) { 
        obj['money_source'] = moneySource;
        obj['bonus_id'] = bonusId;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('bonus_id')) {
                obj['bonus_id'] = ApiClient.convertToType(data['bonus_id'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Bonus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Bonus</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Bonus.RequiredProperties) {
            if (!data[property]) {
...
Bonus.RequiredProperties = ["money_source", "bonus_id"];

/**
 * Тип создаваемой заявки.
 * @member {module:model/Bonus.MoneySourceEnum} money_source
 */
Bonus.prototype['money_source'] = undefined;

/**
 * Идентификатор администратора, на которого зарегистрирован домен.
 * @member {Number} person_id
 */
Bonus.prototype['person_id'] = undefined;

/**
 * Идентификатор бонуса.
 * @member {Number} bonus_id
 */
Bonus.prototype['bonus_id'] = undefined;
