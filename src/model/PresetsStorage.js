...
/**
 * The PresetsStorage model module.
 * @module model/PresetsStorage
 * @version 1.0.0
 */
class PresetsStorage {
    /**
     * Constructs a new <code>PresetsStorage</code>.
     * Тариф
     * @alias module:model/PresetsStorage
     * @param id {Number} Уникальный идентификатор для каждого экземпляра тарифа хранилища.
    ...
    /**
     * Constructs a <code>PresetsStorage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PresetsStorage} obj Optional instance to populate.
     * @return {module:model/PresetsStorage} The populated <code>PresetsStorage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PresetsStorage();
    ...
    /**
     * Validates the JSON data with respect to <code>PresetsStorage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PresetsStorage</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PresetsStorage.RequiredProperties) {
            if (!data[property]) {
 ...
 * @member {Number} id
 */
PresetsStorage.prototype['id'] = undefined;

/**
 * Описание тарифа.
 * @member {String} description
 */
PresetsStorage.prototype['description'] = undefined;

/**
 * Краткое описание тарифа.
 * @member {String} description_short
 */
PresetsStorage.prototype['description_short'] = undefined;

/**
 * Описание диска хранилища.
 * @member {Number} disk
 */
PresetsStorage.prototype['disk'] = undefined;

/**
 * Стоимость тарифа хранилища.
 * @member {Number} price
 */
PresetsStorage.prototype['price'] = undefined;

/**
 * Географическое расположение тарифа.
 * @member {module:model/PresetsStorage.LocationEnum} location
 */
