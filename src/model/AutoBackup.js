...
/**
 * The AutoBackup model module.
 * @module model/AutoBackup
 * @version 1.0.0
 */
class AutoBackup {
    /**
     * Constructs a new <code>AutoBackup</code>.
     * @alias module:model/AutoBackup
     * @param isEnabled {Boolean} Включено ли автобэкапирование
     */
    constructor(isEnabled) { 
        
        AutoBackup.initialize(this, isEnabled);
    }
    ...
    /**
     * Constructs a <code>AutoBackup</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AutoBackup} obj Optional instance to populate.
     * @return {module:model/AutoBackup} The populated <code>AutoBackup</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AutoBackup();
    ...
    /**
     * Validates the JSON data with respect to <code>AutoBackup</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AutoBackup</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AutoBackup.RequiredProperties) {
            if (!data[property]) {
 ...
 */
AutoBackup.prototype['day_of_week'] = undefined;
