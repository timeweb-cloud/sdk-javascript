...
export default class DomainsApi {
    ...
    */
     ...
     * @param {Number} requestId ID заявки на регистрацию/продление/трансфер домена.
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} [personId] ID администратора, на которого зарегистрирован домен.
     ...
     * @param {Number} tldId ID доменной зоны.
