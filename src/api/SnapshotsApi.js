...
export default class SnapshotsApi {
    ...
    */
     ...
     * @callback module:api/SnapshotsApi~commitRestorePointCallback
     ...
     * @param {module:api/SnapshotsApi~commitRestorePointCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/SnapshotsApi~createRestorePointCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} vdsId ID облачного сервера (VDS).
     * @param {module:api/SnapshotsApi~createRestorePointCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/SnapshotsApi~getRestorePointCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetRestorePoint200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} vdsId ID облачного сервера (VDS).
     * @param {module:api/SnapshotsApi~getRestorePointCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetRestorePoint200Response}
     */
     ...
     * @callback module:api/SnapshotsApi~getRestorePointsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/SnapshotsApi~getRestorePointsCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/SnapshotsApi~rollbackRestorePointCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} vdsId ID облачного сервера (VDS).
     * @param {module:api/SnapshotsApi~rollbackRestorePointCallback} callback The callback function, accepting three arguments: error, data, response
     */
